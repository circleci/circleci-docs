...
:page-audience: admin
:page-description: Learn about CircleCI Server 4.9 usage data collection for the purpose of improving our product and services.
:experimental:
...
== Current data collected
server 4.9 does not include the data collection service.

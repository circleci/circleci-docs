...
This page describes how to configure external services for use with either a new CircleCI server 4.9 installation or migrating internal PostgreSQL and MongoDB data from existing CircleCI server 4.9 installation to your externalized datastores.

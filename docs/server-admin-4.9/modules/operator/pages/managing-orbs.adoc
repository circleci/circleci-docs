...
:page-audience: admin
:page-description: Use this page to learn about orbs and how to manage them within CircleCI Server 4.9.
:experimental:
...
Orbs are accessed via the xref:guides:toolkit:circleci-cli.adoc#[CircleCI CLI]. Orbs require your CircleCI user to be an admin. They also require a xref:guides:toolkit:managing-api-tokens.adoc#[personal API token].

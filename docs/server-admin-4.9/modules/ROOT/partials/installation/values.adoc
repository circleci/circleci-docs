...
| api_service.resources.requests.cpu
| string
| `"300m"`
|

| api_service.resources.requests.memory
| string
| `"1Gi"`
|
...
| audit_log_service.resources.requests.cpu
| string
| `"200m"`
|

| audit_log_service.resources.requests.memory
| string
| `"700M"`
|

| authentication_service.auth_api.rate_limit.burst
| int
| `50`
| Burst allowance for the catch-all limit (RATE_LIMIT_BURST). Auth-api default: 50.

| authentication_service.auth_api.rate_limit.count
| int
| `300`
| Sustained request rate for the catch-all limit (RATE_LIMIT_COUNT). Auth-api default: 300.

| authentication_service.auth_api.rate_limit.enabled
| bool
| `true`
| Enable Gubernator per-user rate limiting on auth-api (maps to RATE_LIMIT_DISABLED when false).

| authentication_service.auth_api.replicas
| int
| `1`
| Number of replicas to deploy for the authentication-service auth api deployment.

| authentication_service.auth_api.resources.limits.cpu
| int
| `2`
| CPU limit for the authentication-service auth api deployment.

| authentication_service.auth_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the authentication-service auth api deployment.

| authentication_service.auth_api.resources.requests.cpu
| int
| `1`
| CPU request for the authentication-service auth api deployment.

| authentication_service.auth_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the authentication-service auth api deployment.

| authentication_service.internal_api.replicas
| int
| `1`
| Number of replicas to deploy for the authentication-service internal api deployment.

| authentication_service.internal_api.resources.limits.cpu
| int
| `2`
| CPU limit for the authentication-service internal api deployment.

| authentication_service.internal_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the authentication-service internal api deployment.

| authentication_service.internal_api.resources.requests.cpu
| int
| `1`
| CPU request for the authentication-service internal api deployment.

| authentication_service.internal_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the authentication-service internal api deployment.

| authentication_service.login_api.replicas
| int
| `1`
| Number of replicas to deploy for the authentication-service login api deployment.

| authentication_service.login_api.resources.limits.cpu
| int
| `2`
| CPU limit for the authentication-service login api deployment.

| authentication_service.login_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the authentication-service login api deployment.

| authentication_service.login_api.resources.requests.cpu
| int
| `1`
| CPU request for the authentication-service login api deployment.

| authentication_service.login_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the authentication-service login api deployment.

| authentication_service.users_bff.replicas
| int
| `1`
| Number of replicas to deploy for the authentication-service login api deployment.

| authentication_service.users_bff.resources.limits.cpu
| int
| `2`
| CPU limit for the authentication-service users bff deployment.

| authentication_service.users_bff.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the authentication-service users bff deployment.

| authentication_service.users_bff.resources.requests.cpu
| int
| `1`
| CPU request for the authentication-service users bff deployment.

| authentication_service.users_bff.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the authentication-service users bff deployment.

| authentication_service.worker.replicas
| int
| `1`
| Number of replicas to deploy for the authentication-service worker deployment.

| authentication_service.worker.resources.limits.cpu
| int
| `2`
| CPU limit for the authentication-service worker deployment.

| authentication_service.worker.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the authentication-service worker deployment.

| authentication_service.worker.resources.requests.cpu
| int
| `1`
| CPU request for the authentication-service worker deployment.

| authentication_service.worker.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the authentication-service worker deployment.
...
| branch_service.resources.requests.cpu
| string
| `"500m"`
| CPU request for the branch-service deployment.

| branch_service.resources.requests.memory
| string
| `"256Mi"`
| Memory request for the branch-service deployment.

| builds_service.custom_max_run_time
| string
| `"5h"`
| Custom maximum runtime for Machine and Docker jobs

| builds_service.jvmHeapSize
| string
| `"3g"`
| JVM heap size for the builds-service JVM.
...
| builds_service.resources.requests.cpu
| string
| `"100m"`
| CPU request for the builds-service deployment.

| builds_service.resources.requests.memory
| string
| `"300Mi"`
| Memory request for the builds-service deployment.

| ciam_gateway.internal_api.replicas
| int
| `1`
| Number of replicas to deploy for the ciam-gateway-service internal deployment.

| ciam_gateway.internal_api.resources.limits.cpu
| int
| `2`
| CPU limit for the ciam-gateway-service internal api deployment.

| ciam_gateway.internal_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the ciam-gateway-service internal api deployment.

| ciam_gateway.internal_api.resources.requests.cpu
| int
| `1`
| CPU request for the ciam-gateway-service internal api deployment.

| ciam_gateway.internal_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the ciam-gateway-service internal api deployment.

| ciam_gateway.outgoing_api.replicas
| int
| `1`
| Number of replicas to deploy for the ciam-gateway-service outgoing deployment.

| ciam_gateway.outgoing_api.resources.limits.cpu
| int
| `2`
| CPU limit for the ciam-gateway-service outgoing api deployment.

| ciam_gateway.outgoing_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the ciam-gateway-service outgoing api deployment.

| ciam_gateway.outgoing_api.resources.requests.cpu
| int
| `1`
| CPU request for the ciam-gateway-service outgoing api deployment.

| ciam_gateway.outgoing_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the ciam-gateway-service outgoing api deployment.

| ciam_gateway.public_api.replicas
| int
| `1`
| Number of replicas to deploy for the ciam-gateway-service public deployment.

| ciam_gateway.public_api.resources.limits.cpu
| int
| `2`
| CPU limit for the ciam-gateway-service public api deployment.

| ciam_gateway.public_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the ciam-gateway-service public api deployment.

| ciam_gateway.public_api.resources.requests.cpu
| int
| `1`
| CPU request for the ciam-gateway-service public api deployment.

| ciam_gateway.public_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the ciam-gateway-service public api deployment.

| ciam_service.internal_admin_api.replicas
| int
| `1`
| Number of replicas to deploy for the ciam-service internal admin deployment.

| ciam_service.internal_admin_api.resources.limits.cpu
| int
| `2`
| CPU limit for the ciam-service internal admin api deployment.

| ciam_service.internal_admin_api.resources.limits.memory
| string
| `"512Mi"`
| Memory limit for the ciam-service internal admin api deployment.

| ciam_service.internal_admin_api.resources.requests.cpu
| int
| `1`
| CPU request for the ciam-service internal admin api deployment.

| ciam_service.internal_admin_api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the ciam-service internal admin api deployment.
...
| contexts_service.resources.requests.cpu
| string
| `"100m"`
| CPU request for the contexts-service deployment.

| contexts_service.resources.requests.memory
| string
| `"300Mi"`
| Memory request for the contexts-service deployment.
...
| cron_service.resources.requests.cpu
| string
| `"50m"`
|

| cron_service.resources.requests.memory
| string
| `"250Mi"`
|
...
| distributor_cleaner.resources.requests.cpu
| string
| `"256m"`
|

| distributor_cleaner.resources.requests.memory
| string
| `"512Mi"`
|
...
| distributor_dispatcher.resources.requests.cpu
| string
| `"256m"`
|

| distributor_dispatcher.resources.requests.memory
| string
| `"512Mi"`
|
...
| distributor_external.resources.requests.cpu
| string
| `"256m"`
| CPU request for the distributor-external deployment.

| distributor_external.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the distributor-external deployment.
...
| distributor_internal.resources.requests.cpu
| string
| `"256m"`
| CPU request for the distributor-internal deployment.

| distributor_internal.resources.requests.memory
| string
| `"256Mi"`
| Memory request for the distributor-internal deployment.
...
| docker_provisioner.custom_config
| string
| `""`
...
| docker_provisioner.external.resources.requests.cpu
| float
| `0.5`
| CPU request for the docker-provisioner-externalapi deployment

| docker_provisioner.external.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the docker-provisioner-externalapi deployment
...
| docker_provisioner.internal.resources.requests.cpu
| float
| `0.5`
| CPU request for the docker-provisioner-internalapi deployment

| docker_provisioner.internal.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the docker-provisioner-internalapi deployment
...
| docker_provisioner.provisioner.resources.requests.cpu
| float
| `0.5`
| CPU request for the docker-provisioner-provisioner deployment

| docker_provisioner.provisioner.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the docker-provisioner-provisioner deployment

| docker_provisioner.reaperContainerRepository
| string
| `""`
| Repository to use to download the reaper container. Must contain the `pause:3.6` image

| domain_service.providersMangerMaxPoolSize
| int
| `10`
| Max pool size for the providers manager
...
| domain_service.resources.requests.cpu
| string
| `"100m"`
| CPU request for the domain-service deployment.

| domain_service.resources.requests.memory
| string
| `"500Mi"`
| Memory request for the domain-service deployment.
...
| execution_gateway.api.resources.requests.cpu
| int
| `1`
| CPU request for the execution-gateway-api deployment

| execution_gateway.api.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the execution-gateway-api deployment
...
| execution_gateway.public_api.resources.requests.cpu
| int
| `1`
| CPU request for the execution-gateway-publicapi deployment

| execution_gateway.public_api.resources.requests.memory
| string
| `"1536Mi"`
| Memory request for the execution-gateway-publicapi deployment

| frontend.jvmHeapSize
| string
| `"3g"`
|
...
| string
| `"250m"`
| CPU request for the frontend deployment.

| frontend.resources.requests.memory
| string
| `"1536Mi"`
| Memory request for the frontend deployment.
...
| string
| `""`
| License (2 Options) For your CircleCI Installation <br> **Option 1:** Set the value global.license and CircleCI will create the secret automatically. <br> **Option 2:** Leave this blank, and create the secret yourself. CircleCI will assume it exists. <br> The secret must be named 'license' and have the key 'license' (where the value equals the base64 encoded string of your license). It must be in the same namespace as your installation.
...
| global.otel.collector_host
| string
| `""`
|

| global.otel.collector_port
| int
| `4317`
|
...
| insights_service.resources.limits.memory
| string
| `"2G"`
| Memory limit for the insights-service deployment.

| insights_service.resources.requests.ephemeral-storage
| string
| `"400M"`
| Ephemeral storage request for the insights-service deployment.

| insights_service.resources.requests.memory
| string
| `"1.2G"`
| Memory request for the insights-service deployment.
...
| bool
| `false`
| This setting controls the automatic fetching and renewal of Let's Encrypt certificates. It defaults to false. If set to true, you must ensure that the appropriate DNS entries are in place after the Helm install/upgrade. The ACME certificate will only be generated when a valid DNS entry is configured for your domain (and the app subdomain).

| kong.additionalHosts
| list
| `[]`
| Additional hostnames that Kong should accept for routing (e.g., for webhooks from external domains).
...
| legacy_notifier.resources.requests.cpu
| string
| `"200m"`
|

| legacy_notifier.resources.requests.memory
| string
| `"800Mi"`
|

| lock_job_provider.consumer.replicas
| int
| `1`
|

| lock_job_provider.consumer.resources.limits.cpu
| string
| `"100m"`
|

| lock_job_provider.consumer.resources.limits.memory
| string
| `"512Mi"`
|

| lock_job_provider.consumer.resources.requests.cpu
| string
| `"0.1"`
|

| lock_job_provider.consumer.resources.requests.memory
| string
| `"512Mi"`
|

| lock_job_provider.internalapi.replicas
| int
| `1`
|

| lock_job_provider.internalapi.resources.limits.cpu
| string
| `"100m"`
|

| lock_job_provider.internalapi.resources.limits.memory
| string
| `"512Mi"`
|

| lock_job_provider.internalapi.resources.requests.cpu
| string
| `"0.1"`
|

| lock_job_provider.internalapi.resources.requests.memory
| string
| `"512Mi"`
|

| machine_provisioner.agent_base_url
| string
...
| machine_provisioner.custom_config
| string
| `""`
...
| machine_provisioner.external.resources.requests.cpu
| string
| `"1"`
| CPU request for the machine-provisioner-externalapi deployment

| machine_provisioner.external.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the machine-provisioner-externalapi deployment
...
| machine_provisioner.internal.resources.requests.cpu
| float
| `0.5`
| CPU request for the machine-provisioner-internalapi deployment

| machine_provisioner.internal.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the machine-provisioner-internalapi deployment
...
| machine_provisioner.leader.resources.requests.cpu
| float
| `0.5`
| CPU request for the machine-provisioner-leader deployment

| machine_provisioner.leader.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the machine-provisioner-leader deployment
...
| machine_provisioner.providers.ec2.allowIMDSv1
| bool
| `false`
| Enable support for IMDSv1 on EC2 machine executor instances. Only IMDSv2 is supported by default.

| machine_provisioner.providers.ec2.assumedRoleArn
| string
| `""`
...
| machine_provisioner.providers.ec2.iops
| int
| `0`
| EBS volume IOPS value. Backend default is 5000 if not specified. <br> IOPS can range from 3,000 to 16,000 for gp3 volumes. <br> Maximum of 500 IOPS per GiB of volume size.

| machine_provisioner.providers.ec2.throughput
| int
| `0`
| EBS volume throughput in MB/s. Backend default is 500 if not specified. <br> Throughput can range from 125 to 1,000 MiB/s for gp3 volumes.
...
| machine_provisioner.provisioner.resources.requests.cpu
| float
| `0.5`
| CPU request for the machine-provisioner-provisioner deployment

| machine_provisioner.provisioner.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the machine-provisioner-provisioner deployment

| machine_provisioner.terminatePendingLinuxAfter
| string
| `"6m"`
| Linux pending machine timeout. Machine instances will be terminted if they take longer than this to start

| machine_provisioner.terminatePendingWindowsAfter
| string
| `"6m"`
...
| no_op_job_provider.replicas
| int
| `1`
|

| no_op_job_provider.resources.limits.cpu
| string
| `"100m"`
|

| no_op_job_provider.resources.limits.memory
| string
| `"512Mi"`
|

| no_op_job_provider.resources.requests.cpu
| string
| `"100m"`
|

| no_op_job_provider.resources.requests.memory
| string
| `"512Mi"`
|
...
| Configure Nomad clients mTLS only when using External Nomad Servers
...
| nomad.server.image.repository
| string
| `"hashicorp/nomad"`
| The Docker image repository for the Nomad Server. Note this repository is not managed by CircleCI.

| nomad.server.image.tag
| string
| `"1.11.3"`
| Nomad has been tested against this specific version tag; edit this value at your own risk.

| nomad.server.internal
| bool
| `true`
| Disables deploying this chart's Internal Nomad servers

| nomad.server.limits.http_max_conns_per_client
| string
| `""`
| Maximum number of concurrent HTTP connections per client IP. When not set, Nomad applies its default of 100.

| nomad.server.limits.rpc_max_conns_per_client
| string
| `""`
| Maximum number of concurrent RPC connections per client IP. When not set, Nomad applies its default of 100. Increase for large clusters with many Nomad clients.

| nomad.server.livenessProbe.failureThreshold
| int
| `6`
|

| nomad.server.livenessProbe.initialDelaySeconds
| int
| `90`
|
...
| nomad.server.podAnnotations
| object
| `{}`
| Annotations to add to the Nomad Server pods.
...
| nomad.server.resources.limits.cpu
| int
| `1`
| CPU limit configuration for the Nomad Server deployment.

| nomad.server.resources.limits.memory
| string
| `"1G"`
| Memory limit configuration for the Nomad Server deployment.

| nomad.server.resources.requests.cpu
| string
| `"50m"`
| CPU request configuration for the Nomad Server deployment.

| nomad.server.resources.requests.memory
| string
| `"100M"`
| Memory request configuration for the Nomad Server deployment.

| nomad.server.rpc.mTLS
| object
| `{"CACertificate":"","certificate":"","enabled":true,"privateKey":""}`
| Nomad mTLS (2 Options), strongly suggested for RPC communication <br> Encrypts traffic and authenticates clients to ensure no unauthenticated clients can join the cluster. <br> **Option 1:** Provide the CACertificate, certificate, and privateKey values - CircleCI will create the secret for you. <br> **Option 2:** Leave the value blank (default) and create the secret yourself. If the values are populated, CircleCI will use them. <br> The secret must be named 'nomad-mtls', be in the same namespace, and have the key:values of: ca.pem: 'base64-encoded-certificate-authority', key.pem: 'base64-encoded-private-key', cert.pem: 'base64-encoded-certificate'.

| nomad.server.serverHostname
| string
| `"cluster.local"`
| - When nomad.server.internal is false, use `serverHostname` to set the URL for connecting to your external nomad servers
...
| oidc_service.base_url
| string
| `""`
| Override the OIDC issuer base URL. If set, tokens will use this as the issuer instead of the Server domain (global.domainName). Use this when your Server domain is not publicly accessible and OIDC tokens need to be verified by external providers (AWS, GCP, JFrog, etc.). The URL should point to a publicly accessible endpoint that serves the JWKS files (e.g. an API Gateway, S3 bucket, or CloudFront distribution). Example: "https://abc123def.execute-api.us-east-1.amazonaws.com"
...
| opentelemetry-collector.config.processors.filter/traces_lowSignal.error_mode
| string
| `"ignore"`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[0]
| string
| `"IsMatch(name, \".*(GET )?/live\")"`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[1]
| string
| `"IsMatch(name, \".*(GET )?/ready\")"`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[2]
| string
| `"IsMatch(name, \".*(GET )?/health\")"`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[3]
| string
| `"IsMatch(name, \".*(GET )?/status\")"`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[4]
| string
| `"attributes[\"app.loop_name\"] == \"metric-loop\""`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[5]
| string
| `"attributes[\"service.name\"] == \"head-dump-collector\""`
|

| opentelemetry-collector.config.processors.filter/traces_lowSignal.traces.span[6]
| string
| `"IsMatch(name, \"Firewalker handling file\")"`
|

| opentelemetry-collector.config.receivers.jaeger
| object
| `{}`
|

| opentelemetry-collector.config.receivers.otlp.protocols.grpc.endpoint
| string
| `"0.0.0.0:4317"`
|

| opentelemetry-collector.config.receivers.prometheus
| object
| `{}`
|

| opentelemetry-collector.config.receivers.zipkin
| object
| `{}`
|
...
| opentelemetry-collector.fullnameOverride
| string
| `"otel-collector"`
|
...
| opentelemetry-collector.livenessProbe.terminationGracePeriodSeconds
| int
| `10`
|
...
| opentelemetry-collector.ports.jaeger-compact.enabled
| bool
| `false`
|

| opentelemetry-collector.ports.jaeger-grpc.enabled
| bool
| `false`
|

| opentelemetry-collector.ports.jaeger-thrift.enabled
| bool
| `false`
|

| opentelemetry-collector.ports.zipkin.enabled
| bool
| `false`
|

| opentelemetry-collector.readinessProbe.initialDelaySeconds
| int
| `5`
|
...
| orb_service.resources.requests.cpu
| string
| `"100m"`
|

| orb_service.resources.requests.memory
| string
| `"300Mi"`
|
...
| output.internal.resources.requests.cpu
| int
| `1`
| CPU request for the output-internal deployment.

| output.internal.resources.requests.memory
| string
| `"1Gi"`
| Memory request for the output-internal deployment.

| output.public
| object
| `{"replicas":1,"resources":{"limits":{"memory":"512Mi"},"requests":{"cpu":0.5,"memory":"512Mi"}}}`
...
| output.public.resources.requests.cpu
| float
| `0.5`
| CPU request for the output-public deployment.

| output.public.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the output-public deployment.

| output.receiver
| object
| `{"replicas":1,"resources":{"limits":{"memory":"1Gi"},"requests":{"cpu":0.5,"memory":"1Gi"}}}`
...
| output.receiver.resources.requests.cpu
| float
| `0.5`
| CPU request for the output-receiver deployment.

| output.receiver.resources.requests.memory
| string
| `"1Gi"`
| Memory request for the output-receiver deployment.
...
| permissions_service.resources.requests.cpu
| string
| `"50m"`
| CPU request for the permissions-service deployment.

| permissions_service.resources.requests.memory
| string
| `"300Mi"`
| Memory request for the permissions-service deployment.
...
| policy_service.resources.requests.cpu
| string
| `"100m"`
|

| policy_service.resources.requests.memory
| string
| `"128Mi"`
|
...
| policy_service_internal.resources.requests.cpu
| string
| `"100m"`
|

| policy_service_internal.resources.requests.memory
| string
| `"128Mi"`
|
...
| string
| `""`
| Name of existing secret to use for PostgreSQL credentials. `auth.postgresPassword` and `auth.password` will be ignored and picked up from this secret. The existing secret must contain the key `postgres-password` when postgresql.internal is true or `password` when postgresql.internal is false
...
| string
| `"postgresql"`
| The host and port below are used by the CirceCI application to locate PostgreSQL DB. These values are not used by the PostgreSQL chart.
...
| postgresql.primary.labels.app
| string
| `"postgres"`
|

| postgresql.primary.labels.layer
| string
| `"data"`
|
...
| postgresql.primary.podLabels.app
| string
| `"postgres"`
|

| postgresql.primary.podLabels.layer
| string
| `"data"`
|

| postgresql.readReplicas.labels.app
| string
| `"postgres"`
|

| postgresql.readReplicas.labels.layer
| string
| `"data"`
|

| postgresql.readReplicas.podLabels.app
| string
| `"postgres"`
|

| postgresql.readReplicas.podLabels.layer
| string
| `"data"`
|

| postgresql.secureMode
| bool
| `false`
| Set to true if PostgreSQL database connections is encrypted. Keep it false when postgresql.internal is true.
...
| public_api_service.replicas
| int
| `1`
|

| public_api_service.resources.limits.cpu
| string
| `"0.2"`
|

| public_api_service.resources.limits.memory
| string
| `"1024Mi"`
|

| public_api_service.resources.requests.cpu
| string
| `"0.1"`
|

| public_api_service.resources.requests.memory
| string
| `"512Mi"`
|
...
| string
| `""`
| The erlang cookie for your rabbitMQ instance. The string can be provided here in the values.yaml or in in a secret with the key, `rabbitmq-erlang-cookie`. If you are using a secret, leave this empty and provide the name of your secret below in `existingErlangSecret`.

| rabbitmq.auth.existingErlangSecret
| string
| `""`
| Must contain the key `rabbitmq-erlang-cookie`

| rabbitmq.auth.existingPasswordSecret
| string
| `""`
| Must contain the key `rabbitmq-password`

| rabbitmq.auth.password
| string
| `""`
| The password of your rabbitMQ admin user. The password can be provided here in the values.yaml or in in a secret with the key, `rabbitmq-password`. If you are using a secret, leave this empty and provide the name of your secret below in `existingPasswordSecret`.
...
| rabbitmq.memoryHighWatermark.enabled
| bool
| `true`
|
...
| rabbitmq.memoryHighWatermark.value
| float
| `0.4`
|
...
| rabbitmq.secure_amqp
| bool
| `false`
| When set to true, amqps is used.
...
| soketi.resources.limits.cpu
| string
| `"1000m"`
| CPU limit for the soketi deployment.

| soketi.resources.limits.memory
| string
| `"1Gi"`
| Memory limit for the soketi deployment.

| soketi.resources.requests.cpu
| string
| `"10m"`
| CPU request for the soketi deployment.

| soketi.resources.requests.memory
| string
| `"32Mi"`
| Memory request for the soketi deployment.
...
| step.internal.resources.requests.cpu
| int
| `1`
| CPU request for the step-internal deployment

| step.internal.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the step-internal deployment
...
| step.receiver.resources.requests.cpu
| int
| `2`
| CPU request for the step-receiver deployment

| step.receiver.resources.requests.memory
| string
| `"512Mi"`
| Memory request for the step-receiver deployment
...
| telegraf.config.outputs[0].file.files[0]
| string
| `"stdout"`
|

| telegraf.custom_config
| string
| `""`
|
...
| Tink Configuration <br> Tink is given precedence over vault. If tink.enabled is true, vault will not be deployed. Tink or vault must be set once at install and cannot be changed. <br> **Option 1:** Leave this blank, and create the secret yourself. CircleCI will assume it exists. <br> The secret must be named 'tink' and have the key; keyset. **Option 2:** Set the values tink.keyset here and CircleCI will create the secret automatically. <br> Generate a keyset via: `tinkey create-keyset --key-template XCHACHA20_POLY1305`
...
| vault
| object
| `{"internal":true,"podAnnotations":{"backup.velero.io/backup-volumes":"data"},"resources":{},"token":"","transitPath":"transit","url":"http://vault:8200"}`
...
| object
| `{}`
| Optional resources for the internal Vault and reset-token containers.

| vault.token
| string
| `""`
| This token is required when `internal: false`. <br> **Option 1:** Leave this blank, and create the secret yourself. CircleCI will assume it exists. <br> The secret must be named 'vault' and have the key; token. <br> **Option 2:** Set the values vault.token here and CircleCI will create the secret automatically.
...
| web_ui.resources.requests.memory
| string
| `"256Mi"`
| Memory request configuration for the web-ui deployment
...
| web_ui_server_admin.resources.requests.memory
| string
| `"256Mi"`
|
...
| webhook_service.resources.requests.cpu
| int
| `1`
| CPU request configuration for the webhook-service deployment.

| webhook_service.resources.requests.memory
| string
| `"2G"`
| Memory request configuration for the webhook-service deployment.
...
| workflows_conductor_event_consumer.resources.requests.cpu
| string
| `"500m"`
|

| workflows_conductor_event_consumer.resources.requests.memory
| string
| `"700Mi"`
|
...
| workflows_conductor_grpc.resources.requests.cpu
| string
| `"500m"`
|

| workflows_conductor_grpc.resources.requests.memory
| string
| `"700Mi"`
|

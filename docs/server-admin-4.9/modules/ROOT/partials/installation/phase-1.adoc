...
| Install and configure link:AWS CLI for your storage provider (SeaweedFS) if you choose not to use AWS or GCP object storage.
| TBC
...
If you are installing locally rather than in AWS or GCP, follow the SeaweedFS instructions in the xref:server-admin:air-gapped-installation:phase-2-configure-object-storage.adoc#[Air-gapped Installation] guide.

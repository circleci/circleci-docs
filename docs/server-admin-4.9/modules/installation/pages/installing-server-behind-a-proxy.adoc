...
Configuring a proxy happens during phase 2, core services (xref:phase-2-aws-core-services.adoc#m-installing-behind-a-proxy[AWS], xref:phase-2-gcp-core-services.adoc#m-installing-behind-a-proxy[GCP]).

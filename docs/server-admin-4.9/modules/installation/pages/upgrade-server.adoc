...
:page-audience: admin
:page-description: "This document lists the steps required to upgrade a CircleCI Server 4.9 installation."
:experimental:

This page describes the steps needed to upgrade your CircleCI Server installation to 4.9.

[#path]
== Upgrade paths

IMPORTANT: Before upgrading to server 4.9, you must first upgrade to the final patch release of server 4.8.x, which is {serverversion48}.
...
* Ensure your internal or external MongoDB instance is updated to version 4.4 or later before you begin. For instructions, see the xref:operator:upgrade-mongo.adoc#[Upgrade MongoDB] guide.

...
:page-audience: admin
:page-description: How to install the CircleCI Server 4.9 Helm deployment to an air-gapped environment.
:experimental:
...
----
helm install circleci-server ./circleci-server/ -n <kubernetes-namespace> --version {serverversion49} -f <path-to-values.yaml>
----

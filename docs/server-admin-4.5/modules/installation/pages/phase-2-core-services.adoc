...
:page-description: Installation guide for CircleCI server v4.5 core services.
:icons: font
:toc: macro
:toc-title:
...
Before you begin with the CircleCI server v4.5 core services installation phase, ensure all xref:air-gapped-installation:phase-1-prerequisites.adoc[prerequisites] are met.
...
helm install circleci-server oci://cciserver.azurecr.io/circleci-server -n $namespace --version {serverversion45} -f <path-to-values.yaml>
----

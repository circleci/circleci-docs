...
NOTE: For installation instructions, you have the option of either the xref:air-gapped-installation:phase-1-prerequisites.adoc[regular] or xref:air-gapped-installation:phase-1-prerequisites.adoc[air-gapped] installation guide.

.CircleCI server v4.3 Architecture
image::guides:ROOT:server-4-architecture-diagram.png[Server v4.3 services architecture]
...
| Local installation
| Tested
| See xref:air-gapped-installation:phase-1-prerequisites.adoc[Air-gapped installation] docs
...
* xref:release-notes.adoc[CircleCI server v4.3 release notes]
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Server v4.3 Installation Prerequisites]
endif::pdf[]

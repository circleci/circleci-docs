...
| Y
| Logic
| xref:configuration-reference.adoc#legacy-logic-statements[A logic statement]
...
| Y
| Logic
| xref:reference:ROOT:configuration-reference.adoc#legacy-logic-statements[A logic statement]

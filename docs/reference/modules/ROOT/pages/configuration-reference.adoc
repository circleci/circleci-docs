...
| Y
| Logic
| xref:configuration-reference.adoc#logic-statements[A logic statement] (or use xref:configuration-reference.adoc#using-expressions-in-your-configuration[expressions] in workflow/job filters instead)

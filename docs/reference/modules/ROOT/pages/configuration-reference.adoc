...
NOTE: CircleCI recommends using xref:#using-expressions-in-your-configuration[expressions] for conditional logic in your configuration. The logic statement syntax described in this section still works, but expressions provide a more intuitive and flexible approach.

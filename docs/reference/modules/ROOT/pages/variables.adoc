...
The following built-in environment variables are available for CircleCI projects. Some environment variables are available for GitHub OAuth and Bitbucket Cloud projects and are deprecated for GitLab, GitHub App, and GitHub Enterprise Server support. If you must continue to use those as environment variables in your GitLab pipelines, refer to the workaround described after the list below.

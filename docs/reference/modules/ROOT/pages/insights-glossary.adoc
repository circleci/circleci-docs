...
:page-aliases: guides:insights:insights-glossary.adoc
:experimental:
...
| Workflow Runs
| The count of all workflow executions for an organization for the selected projects in the selected time frame.

| Total Workflow Duration
| The total execution time of all workflow runs for an organization within the selected projects and time frame.

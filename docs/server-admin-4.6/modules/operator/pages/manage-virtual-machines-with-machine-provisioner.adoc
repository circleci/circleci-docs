...
:page-description: CircleCI server v4.6 machine provisioner service controls how machine executor (Linux and Windows images) and Remote Docker jobs are run.
:icons: font
:toc: macro
:toc-title:
...
CAUTION: We recommend that you leave these options at their defaults until you have successfully configured and verified the core and build services of your server installation. Steps to set up machine provisioner are provided in the installation guide for xref:installation:phase-3-execution-environments.adoc#aws-machine-provisioner[AWS] and xref:installation:phase-3-execution-environments.adoc#gcp-authentication[GCP].
...
[#aws]
=== AWS
Configure machine provisioner to work with AWS EC2 in your `values.yaml` file. During installation you will have set up a security group and authentication. See the xref:installation:phase-3-execution-environments.adoc#aws-machine-provisioner[Installation Phase 3 - Execution Environments] page for more information.
...
[#gcp]
=== GCP
Configure machine provisioner to work with GCP in your `values.yaml` file. During installation you will have set up a security group and authentication. See the xref:installation:phase-3-execution-environments.adoc#aws-machine-provisioner[Installation Phase 3 - Execution Environments] page for more information.

...
:page-description: Reference documentation for installing CircleCI server v4.6.
:icons: font
:toc: macro
:toc-title:
...
follow this guide:
https://circleci.com/docs/server/v4.6/operator/expanding-internal-database-volumes

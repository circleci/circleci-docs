= CircleCI server v4.6 overview
:page-noindex: true
:page-platform: Server v4.6, Server Admin
:page-description: CircleCI server v4.6 is a continuous integration and continuous delivery (CI/CD) platform that you can install on your GCP or AWS Kubernetes cluster.
:icons: font
:toc: macro
:toc-title:
...
.CircleCI server v4.6 Architecture
image::guides:ROOT:server-4-architecture-diagram-2024.png[Server v4.6 services architecture]
...
CircleCI server v4.6 consists of the following services. Find their descriptions and failure implications below:

[.table.table-striped]
[cols="4,1,3,3,3", options="header", stripes=even]
|===
| Service
| Component
| Description
...
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Cloud] installation guide. Follow the sections for your chosen cloud provider.
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Local] installation. Notes are provided in the main installation guide to show which sections are optional, or different, for local installations.
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Air-gapped] installation guide. This guide is designed to be used along-side key sections of the main xref:air-gapped-installation:phase-1-prerequisites.adoc[installation guide].
...
* xref:release-notes.adoc[CircleCI server v4.6 release notes]
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Server v4.6 installation prerequisites]
endif::pdf[]

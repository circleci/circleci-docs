...
* Install the link:https://cli.circleci.com/[CircleCI CLI] on your local machine with a link:https://app.circleci.com/settings/user/tokens[personal access token].
+
```shell
circleci update

...
*Commands* contain one or more steps and can accept parameters. See xref:orb-concepts.adoc#commands[Commands] for details.
...
*Jobs* define a collection of steps to run within an executor. See xref:orb-concepts.adoc#jobs[Jobs] for details.
...
*Executors* define the environment in which jobs run. See xref:orb-concepts.adoc#executors[Executors] for details.
...
* xref:orb-concepts.adoc[Orb Concepts].

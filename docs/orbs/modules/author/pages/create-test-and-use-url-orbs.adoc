...
The allow-list entry must include the prefix:
...
[#step-4-use-the-orb]
=== 4. Use the orb in your configuration
...
Trigger a pipeline (via push, API, or web app) to test your orb and observe the results in the CircleCI web app.
...
* xref:author:create-an-inline-orb.adoc[Create an Inline Orb] if you are considering starting with inline orbs.

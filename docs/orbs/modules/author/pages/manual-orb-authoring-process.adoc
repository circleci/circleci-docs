...
This guide covers the steps required to create a simple registry xref:use:orb-intro.adoc[orb], manually, without using the orb development kit. We recommend the xref:orb-development-kit.adoc[orb development kit] for most orb projects.

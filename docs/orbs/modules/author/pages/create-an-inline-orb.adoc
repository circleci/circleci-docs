...
Before creating an inline orb, make sure you are familiar with:
...
TIP: If you do not have the CircleCI CLI installed, see the xref:guides:toolkit:local-cli.adoc[Installing the Local CLI] page for instructions.

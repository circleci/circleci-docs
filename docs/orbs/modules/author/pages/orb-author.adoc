...
CircleCI orbs are packages of xref:use:orb-concepts.adoc#orb-configuration-elements[Reusable Configuration] that you can import into you CircleCI configuration files. Orbs come in two types:

...
* Your orb is hosted in a public GitHub repository
* Your orb is hosted in a public GitLab repository
* Your orb is hosted in a public Bitbucket repository
* Your orb is hosted in a publicly accessible location (for example, AWS S3 with public read access)

Use **GitHub App** when:

* Your orb is hosted in a private GitHub repository
* You have the CircleCI GitHub App installed for your organization
...
* Your orb is hosted in a private GitHub repository
* You do not have the CircleCI GitHub App set up
...
Organizations that want to use URL orbs from both public and private repositories in the same version control system need to create multiple allow-list entries with the same URL prefix but different authentication types.

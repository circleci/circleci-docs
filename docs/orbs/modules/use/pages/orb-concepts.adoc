...
An unlimited number of private registry orbs are available on all of CircleCI's link:https://circleci.com/pricing[plans]. Using a private registry orb enables you to author an orb while ensuring the following:

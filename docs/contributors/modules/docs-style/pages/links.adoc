...
[#cross-references]
== Cross references
* Cross references (links between docs pages) are made using the resource ID of the destination page and section, in the following form:
+
[source,adoc]
----
...
** **Bad:** For more information on adding project-level environment variables head https://circleci.com/docs/set-environment-variable/#set-an-environment-variable-in-a-project[here].

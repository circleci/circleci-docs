...
. Next to the page title when viewing the page.
. Next to the page link in the left sidebar navigation.
...
You can add badges to subsections (h2-h6 headings) using attribute syntax on the section. Subsection badges are useful when a single documentation page covers multiple features with different maturity levels.
...
* Do not include badges in cross-references to the section.

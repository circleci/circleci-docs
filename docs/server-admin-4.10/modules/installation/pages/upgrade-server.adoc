...
:page-audience: admin
:page-description: "This document lists the steps required to upgrade a CircleCI Server 4.10 installation."
:experimental:
...
IMPORTANT: Before upgrading to server 4.10, you must first upgrade to the latest patch release of server 4.9.x which is currently {serverversion49}.
...
* Ensure you have upgraded to the latest patch release of server 4.9.x which is currently {serverversion49}.

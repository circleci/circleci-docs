Before you begin with the CircleCI Server 4.10 post installation phase, ensure you have run through the following:
...
For more information and steps to complete these tasks, see the xref:server-admin:operator:managing-orbs.adoc#[Managing Orbs on Server] guide.
...
* xref:server-admin:operator:backup-and-restore.adoc#[Backup and Restore].
endif::[]

...
:page-audience: admin
:page-description: Use this guide to make the frontend load balancer private for CircleCI Server 4.10.
:experimental:
...
* **GitHub.com:** Set up a proxy for incoming webhooks and set it as override for the webhook host URL. This setting can be found in the CircleCI app UI under menu:Admin Settings[System Settings > Override webhook host URL].
****
...
NOTE: If you change this setting after the initial deployment of CircleCI Server, you may need to delete the old public load balancer. This allows Kubernetes to request a new load balancer with the new configuration.

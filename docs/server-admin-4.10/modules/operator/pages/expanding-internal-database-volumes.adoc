...
:page-audience: admin
:page-description: Expanding internal database volumes for CircleCI Server 4.10.
:experimental:
...
NOTE: As a precaution, it is always a good idea to create a backup of your cluster first. See the xref:backup-and-restore.adoc#[Backup and Restore] guide for more information.

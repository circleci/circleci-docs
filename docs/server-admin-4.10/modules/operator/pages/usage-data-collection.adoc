...
:page-audience: admin
:page-description: Learn about CircleCI Server 4.10 usage data collection for the purpose of improving our product and services.
:experimental:
...
== Current data collected
server 4.10 does not include the data collection service.

...
CAUTION: When using preallocated instances, be aware that a cron job cycles through these instances once per minute. This ensures they do not end up in an unworkable state.

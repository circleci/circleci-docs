...
:page-audience: admin
:page-description: This document outlines recommendations for how to back up and restore your CircleCI Server 4.10 instance data and state.
:experimental:
...
CircleCI recommends link:https://velero.io/[Velero] for backup and restore. The benefit of this approach is in restoring your application's data along with the state of the Kubernetes cluster and its resources at the time of the backup. CircleCI Server supports backup and restore with Velero `1.12`. This document outlines recommendations for how to back up and restore your CircleCI Server instance data and state using link:https://velero.io/[Velero].
...
* link:https://velero.io/docs/v1.12/contributions/minio/[S3 Compatible Storage]

...
Configuring a proxy happens during phase 2, core services (xref:server-admin:installation:phase-2-aws-core-services.adoc#m-installing-behind-a-proxy[AWS], xref:server-admin:installation:phase-2-gcp-core-services.adoc#m-installing-behind-a-proxy[GCP]).

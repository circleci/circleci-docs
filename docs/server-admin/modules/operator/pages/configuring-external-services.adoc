...
:page-description: This document describes how to configure the following external services for use with a CircleCI server v4.6 installation
:icons: font

This page describes how to configure external services for use with either a new CircleCI server v4.6 installation or migrating internal PostgreSQL and MongoDB data from existing CircleCI server v4.6 installation to your externalized datastores.

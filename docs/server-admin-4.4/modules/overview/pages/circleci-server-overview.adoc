...
image::guides:ROOT:server-4-architecture-diagram-2024.png[Server v4.4 services architecture]
...
* xref:release-notes.adoc[CircleCI server v4.4 release notes]
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Server v4.4 Installation Prerequisites]
endif::pdf[]

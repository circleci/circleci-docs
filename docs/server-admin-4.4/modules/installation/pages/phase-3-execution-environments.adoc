...
Before you begin with the CircleCI server v4.4 execution environment installation phase, ensure you have run through xref:phase-1-prerequisites.adoc[Phase 1 – Prerequisites] and xref:phase-2-core-services.adoc[Phase 2 - Core Services Installation].

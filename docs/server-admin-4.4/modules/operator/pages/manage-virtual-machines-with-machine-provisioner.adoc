...
[#aws]
=== AWS
Machine provisioner is configured to work with AWS EC2 in your `values.yaml` file. During installation you will have set up a security group and authentication. See the xref:installation:phase-3-execution-environments.adoc#aws-machine-provisioner[Installation Phase 3 - Execution Environments] page for more information.
...
[#gcp]
=== GCP
Machine provisioner is configured to work with GCP in your `values.yaml` file. During installation you will have set up a security group and authentication. See the xref:installation:phase-3-execution-environments.adoc#aws-machine-provisioner[Installation Phase 3 - Execution Environments] page for more information.

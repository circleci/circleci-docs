...
[#aws]
=== AWS
Configure VM Service to work with AWS EC2 in your `values.yml`. During installation you will have set up a security group and authentication. See the xref:installation:phase-3-execution-environments.adoc#aws-vm-service[Installation Phase 3 - Execution Environments] page for more information.
...
[#gcp]
=== GCP
Configure VM Service to work with GCP in your `values.yml` file. During installation you will have set up a security group and authentication. See the xref:installation:phase-3-execution-environments.adoc#aws-vm-service[Installation Phase 3 - Execution Environments] page for more information.

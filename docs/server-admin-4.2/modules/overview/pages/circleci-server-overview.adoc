...
image::guides:ROOT:server-4-architecture-diagram.png[Server v4.2 services architecture]
...
* xref:release-notes.adoc[CircleCI server v4.2 release notes]
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Server 4.2 Installation Prerequisites]
endif::pdf[]

...
CircleCI Server is an on-premises CI/CD platform for enterprise customers who have compliance or security needs. It lets you operate within your firewall, in a private cloud, or in a data center.
...
image::guides:ROOT:server-4-architecture-diagram-2024.png[Server v4.7 services architecture]
...
| Queuing for workflow messaging, test results, usage, cron jobs, output, notifications, and scheduler.
|
|
...
These can also be configured to be exported to other places, such as Datadog or Prometheus.
|
|
...
| Systems use defaults in place of any flags. In the case of server, this has no effect, since no feature flags are set.
|
...
* Cloud installation guides for xref:server-admin:installation:phase-1-aws-prerequisites.adoc[AWS] and xref:server-admin:installation:phase-1-gcp-prerequisites.adoc[GCP]. Follow the sections for your chosen cloud provider.
* xref:server-admin:installation:phase-1-aws-prerequisites.adoc[Local] installation. Notes are provided in the main installation guide to show which sections are optional, or different, for local installations.
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Air-gapped] installation guide. This guide is designed to be used along-side key sections of the main installation guides for xref:server-admin:installation:phase-1-aws-prerequisites.adoc[AWS] and xref:server-admin:installation:phase-1-gcp-prerequisites.adoc[GCP].
...
* For the v4.7 release, see the xref:release-notes.adoc[Release Notes].
* Server v4.7 installation prerequisites for xref:server-admin:installation:phase-1-aws-prerequisites.adoc[AWS] and xref:server-admin:installation:phase-1-gcp-prerequisites.adoc[GCP].
endif::pdf[]

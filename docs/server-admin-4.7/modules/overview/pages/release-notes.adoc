...
[#upgrade]
== Upgrade
For steps to upgrade to v4.7, see the xref:installation:upgrade-server.adoc[Upgrade Guide].
...
For full details of this release see the link:https://circleci.com/changelog/#server-release-4-7-15[changelog].

== Release 4.7.13

=== Changelog

For full details of this release see the link:https://circleci.com/changelog/#server-release-4-7-13[changelog].

== Release 4.7.12

=== Changelog

For full details of this release see the link:https://circleci.com/changelog/#server-release-4-7-12[changelog].

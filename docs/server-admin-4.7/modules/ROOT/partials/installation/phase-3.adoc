Before you begin with the CircleCI Server v4.7 execution environment installation phase, ensure you have run through the following:
...
.Reality Check pipeline results

...
Data retention for MongoDB and PostgreSQL can be configured by following our guide xref:docs/server-admin-4.7/modules/operator/pages/data-retention.adoc[Data Retention in Server]. 

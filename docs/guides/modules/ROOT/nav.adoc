...
*** xref:deploy:set-up-deploy-validation-manually.adoc[Set up deploy validation manually]
*** xref:deploy:deploy-validation-reference.adoc[Deploy validation configuration reference]

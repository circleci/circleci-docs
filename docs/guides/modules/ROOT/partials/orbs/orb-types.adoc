...
*Inline orbs*:: Inline orbs are defined directly within your project's configuration file. They are project-specific and not published or shared externally. Inline orbs are ideal for reusable configuration within a single project. They are also useful for learning orb concepts and testing configurations before extracting to a URL or registry orb.
+

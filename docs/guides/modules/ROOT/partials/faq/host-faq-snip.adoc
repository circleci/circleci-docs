...
Yes, CircleCI Server is available for installation on AWS or GCP. See the xref:server-admin:overview:circleci-server-overview.adoc[CircleCI Server Overview] for details and links to installation instructions. link:https://circleci.com/pricing/server/[Contact us] to discuss your requirements.

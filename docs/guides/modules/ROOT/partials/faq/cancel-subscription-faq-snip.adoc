...
You must have admin access in your CircleCI organization to cancel your xref:guides:plans-pricing:plan-overview.adoc#performance-plan[Performance Plan] subscription.
...
You will continue to have access to the Performance Plan settings in the CircleCI web app and be able to use credits until the end of your current billing cycle. After the cycle ends, your org will be transitioned to the xref:guides:plans-pricing:plan-overview.adoc#free-plan[Free Plan], where you can use up to 30,000 credits per month.

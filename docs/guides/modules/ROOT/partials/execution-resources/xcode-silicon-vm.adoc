...
a| `m4pro.medium` +
   `m4pro.large`
| link:https://circle-macos-docs.s3.amazonaws.com/image-manifest/v15606/manifest.txt[Installed software]
| link:https://circleci.com/changelog/xcode-26-beta-6-available/[Release Notes]

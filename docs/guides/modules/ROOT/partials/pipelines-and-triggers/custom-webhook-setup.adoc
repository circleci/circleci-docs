...
. Find your project in the list, select the ellipsis image:guides:ROOT:icons/more.svg[more icon], select **Project Settings**, and select **Pipelines** in the sidebar.

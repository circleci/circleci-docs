...
+
.Screenshot showing the schedule trigger form
...
** Under Pipeline attribution, select the actor to initiate the trigger. You can choose yourself, one of your team, or the scheduling system if you want the trigger to be independent from individual users. If your project requires the use of environment variables stored in restricted contexts, you must assign someone who has access to those contexts.
...
** Select a release frequency (weekly/monthly, which days/months/time etc.).

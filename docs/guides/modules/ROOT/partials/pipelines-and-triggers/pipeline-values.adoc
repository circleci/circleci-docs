...
d| [.nowrap]#GitHub App#
| Boolean
| The pull request comment body, if a pipeline was triggered via PR comment. For pipelines triggered in other ways, this value is undefined.
| [.circle-green]#**Yes**#
| [.circle-red]#**No**#
...
d| [.nowrap]#GitHub App#
| String
| The type of GitHub user who triggered the pipeline. Possible values are `User`, `Organization` and `Bot`.
| [.circle-green]#**Yes**#
| [.circle-red]#**No**#

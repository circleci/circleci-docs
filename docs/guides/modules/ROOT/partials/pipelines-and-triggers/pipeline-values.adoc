...
[.nowrap]#GitLab#
| String
| A link:https://en.wikipedia.org/wiki/Universally_unique_identifier[globally unique identifier] for the pipeline.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#GitLab#
| Integer
| A project-scoped integer identifier for the pipeline.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#GitLab#
| String
| The pipeline type, determined by the VCS integration used to check out code. Possible values: `github_app`, `github`, `bitbucket`, `bitbucket_dc`, `gitlab`.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#GitLab#
| String
| The name of the git tag that was pushed to trigger the pipeline. Empty if the pipeline was not triggered by a tag.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#GitLab#
| String
| The name of the git branch that was pushed to trigger the pipeline. Empty if the pipeline was triggered by a tag push.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#GitLab#
| String
| The source that triggers the pipeline. Possible values: `webhook`, `api`, `scheduled_pipeline`.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#Bitbucket Cloud#
| String
| The name of the schedule trigger if the pipeline was triggered via schedule. Empty if the pipeline was not triggered via schedule.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
[.nowrap]#Bitbucket Cloud#
| String
| The unique ID of the schedule if the pipeline was triggered via schedule. Empty if the pipeline was not triggered via schedule.
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.circleci.trigger_type` +
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.circleci.event_type` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App# +
[.nowrap]#GitLab#
| String
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.ref` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.checkout_sha` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.user_id` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.user_name` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.user_username` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
|Use `pipeline.event.github.sender.login` instead.
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.user_avatar` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.repo_name` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.repo_url` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.web_url` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
|Use `pipeline.event.github.repository.url` instead.
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.commit_sha` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.commit_title` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.commit_message` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.commit_timestamp` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
|Use `pipeline.trigger.received_at` instead.
...
| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.commit_author_name` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
|For the user who triggered the push event, use `pipeline.event.github.sender.*`. For the checkout commit author, use `pipeline.git.commit.author_login`.
| [.circle-green]#**Yes**#
| [.circle-red]#**No**#

| image:guides:ROOT:icons/warning.svg[warning icon, role="no-border"] `pipeline.trigger_parameters.github_app.branch` +
*Deprecated* - support ends on 2026-08-01.
d| [.nowrap]#GitHub App#
|
|For push events, use `pipeline.event.github.ref`. For pull request events, use `pipeline.event.github.pull_request.head.ref`.
...
Values prefixed with `+pipeline.deploy.*+` are only available for deployment pipelines. See the xref:guides:deploy:set-up-rollbacks.adoc[Set up a Rollback Pipeline] and xref:guides:deploy:set-up-deploys.adoc[Set up a Deploy Pipeline] guides for more information.

[.table-scroll]
--
[.datatable.no-sort-col-3,cols="2,2,1,5,1,1", options="header"]
|===
| Variable
| Source
| Type

...
[.nowrap]#GitHub App Server#
| String
| The current version of the component that CircleCI will roll back or deploy. Can verify that the component status matches expectations.
| [.circle-green]#**Yes**#
| [.circle-red]#**No**#

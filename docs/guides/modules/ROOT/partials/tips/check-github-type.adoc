...
. Select the ellipsis menu icon:more[Ellipsis menu icon] next to your project and select **Project Settings**. The project slug is listed on the project settings homepage.
...
For more information about the differences, see the xref:guides:integration:version-control-system-integration-overview.adoc[Version Control Systems, Pipeline Types, and Feature Support] guide.
****

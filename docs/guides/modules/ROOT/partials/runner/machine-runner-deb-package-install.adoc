...
. **If you are using CircleCI Server** you will need to provide the URL for your installation. You can do this by either setting the `CIRCLECI_RUNNER_API_URL` environment variable:
+
```shell

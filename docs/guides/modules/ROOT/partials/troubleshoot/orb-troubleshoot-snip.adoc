...
To resolve this error, run `circleci config process` on your configuration and then save that configuration to disk. Then run `circleci local execute` against the processed configuration.

...
* Check that the Deployment/Rollout is annotated with the required labels. More information is available in the xref:guides:deploy:configure-your-kubernetes-components.adoc[Set up Guides]. Adding any missing labels resolves the problem.

...
For a full list of available Linux VM resource classes see the xref:reference:ROOT:configuration-reference.adoc#linuxvm-execution-environment[Configuration Reference].
...
For a full list of available Arm VM resource classes see the xref:reference:ROOT:configuration-reference.adoc#arm-execution-environment-linux[Configuration Reference].

...
NOTE: Gen2/Gen3 resource classes are not currently available for Arm-based remote Docker. Arm-based remote Docker also does not currently support the xref:security:ip-ranges.adoc[IP Ranges].
...
| Remote Docker (Linux Machine) resource class
| `medium.gen3`
| `medium.gen3` (Linux VM)
| `large.gen3`
| `large.gen3` (Linux VM)
| `xlarge.gen3`
| `xlarge.gen3` (Linux VM)
| `2xlarge.gen3`
| `2xlarge.gen3` (Linux VM)
| `2xlarge+.gen3`
| `2xlarge+.gen3` (Linux VM)
|===
--

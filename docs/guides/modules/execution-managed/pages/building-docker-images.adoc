...
NOTE: Gen2 resource classes are not currently available for Arm-based remote Docker. Arm-based remote Docker also does not currently support the xref:security:ip-ranges.adoc[IP Ranges].

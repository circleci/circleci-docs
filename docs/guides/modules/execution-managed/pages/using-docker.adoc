...
| xref:reference:ROOT:configuration-reference.adoc#resourceclass[Configurable resources (CPU/RAM)]
| Yes
| Yes
|===
...
NOTE: This section discusses caching the Docker images used to spin up a Docker execution environment. It does not apply to xref:optimize:docker-layer-caching.adoc[Docker layer caching], which is a feature used to speed up building new Docker images in your projects.

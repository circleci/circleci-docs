...
:page-platform: Cloud, Server 4+
:page-description: Learn about CircleCI resource class lifecycle management.
:experimental:
...
*Check hidden hependencies*:: Inspect all workflows, including those triggered by external events or scheduled runs, to identify all resource class usage.

...
You must authenticate as the user who triggered the rerun. Make sure your username is in the 'Enable SSH' step.

If you have multiple accounts, verify you are authenticated as the correct one. In order to SSH into a CircleCI build, the username must be one which has access to the project being built.

...
include::ROOT:partial$execution-resources/windows-resource-table.adoc[]
...
* Current (formerly Stable): This image tag points to the latest production-ready Windows image. Use this image for projects that want a decent level of stability, but would like to get occasional software updates. It is typically updated once a month.
...
You can read more about using SSH in your builds xref:ssh-access-jobs.adoc[Here].
...
Check out the xref:hello-world-windows.adoc[Hello World on Windows] page.

...
NOTE: Ubuntu 22.04 on gen2 has entered deprecation. We recommend using Ubuntu 26.04 for all new and existing gen2 workloads where possible.
...
- `default`: If you do not specify an image tag, you get this version.
...
| Ubuntu 22.04 LTS
| Deprecated; removal scheduled when Canonical ends support (2027)

| Ubuntu 24.04 LTS
| Supported

| Ubuntu 26.04 LTS
| Supported; `default`, `current`, and `edge` tags
|===
--
...
| Ubuntu 26.04 LTS
| `default`, `current`, and `edge` tags retained
|===
--

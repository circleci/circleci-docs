...
=== 1.1 Organization ID
You need your CircleCI organization ID, in UUID format.

include::guides:ROOT:partial$app-navigation/steps-to-org-id.adoc[]


=== 1.2 Project ID
You need your CircleCI project ID, in UUID format from menu:Project Settings[Overview].

include::guides:ROOT:partial$app-navigation/steps-to-project-id.adoc[]

=== 1.3 Pipeline definition ID
You need your pipeline definition ID, in UUID format from menu:Project Settings[Project Setup]. There you will see your list of pipelines. Find the pipeline that will run the publishing workflow and copy its ID.

include::guides:ROOT:partial$app-navigation/steps-to-project-definition-id.adoc[]
...
If you intend to restrict publishing to a CircleCI context (recommended, see <<lock-it-down,Lock it down with protected contexts>>). Find the UUID for each context under menu:Org Settings[Contexts] and selecting the context.

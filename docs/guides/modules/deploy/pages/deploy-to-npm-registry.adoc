...
You need your pipeline definition ID, in UUID format. You can find your pipeline definition ID in menu:Project Settings[Project Setup], where you will find all pipelines that have been set up for your project along with their definition IDs. Follow these steps to find your pipeline definition IDs:

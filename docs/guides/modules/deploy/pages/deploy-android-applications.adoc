...
Deploy markers provide a way to track and manage your Android app deployments in the CircleCI web app. When you add deploy markers to your deployment job, you can view a timeline of all deployments to the Google Play Store, track their status, and enable rollback and deploy pipelines.

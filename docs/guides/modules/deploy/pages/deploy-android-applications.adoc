...
+
Finally, create your Google Play API key from your `api.json` You have already saved the value with an environment variable `$GOOGLE_PLAY_KEY`. You can refer to this variable and write the `api.json` file at runtime, instead of uploading it to a remote repository.
+

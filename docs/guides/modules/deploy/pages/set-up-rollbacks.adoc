...
A rollback pipeline is also what CircleCI triggers when deploy validation fails and automatic rollback is enabled. For more information, see the xref:set-up-smart-deployments.adoc[Set up Smart Deployments] guide.

...
*Additional settings*:: At the bottom of the modal you can expand the "Additional settings" section in which you can set the following: The namespace for your deployment if your deployment target requires it. You can leave namespace empty, in which case the `default` value will be used. You can set the config and checkout sources for your deployment. The Parameters section shows the auto-filled parameters from your configuration file, which you can modify as needed for the specific deployment.

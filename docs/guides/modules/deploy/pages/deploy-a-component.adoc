...
*Additional settings*:: At the bottom of the modal you can expand the "Additional settings" section to set the namespace for your deployment if your deployment target requires it. You can also set the config and checkout sources for your deployment. The Parameters section shows the auto-filled parameters from your configuration file, which you can modify as needed for the specific deployment operation.

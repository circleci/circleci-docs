...
For the steps to configure validation and connect your monitoring tool by hand, see the xref:set-up-deploy-validation-manually.adoc[Set up Deploy Validation Manually] guide. This page is the field reference for that work.

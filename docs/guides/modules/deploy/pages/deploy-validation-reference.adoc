...
NOTE: The `grafana` and `alertmanager` provider values are valid in your configuration file, even though the guided setup offers only Datadog, Prometheus, and Custom. Choose Prometheus in the guided setup and edit the provider value in the generated pull request, or choose Custom and map the fields yourself.

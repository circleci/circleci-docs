...
Adding deploy markers to your configuration is a prerequisite to using CircleCI rollbacks to rollback to a previous version of a component from the CircleCI web app.

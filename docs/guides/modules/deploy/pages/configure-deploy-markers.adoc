...
Alternatively, you can head straight to set up a rollback pipeline and through that process you will be guided to set up deploy markers. See the xref:set-up-rollbacks.adoc[Set up rollbacks] guide for more details.

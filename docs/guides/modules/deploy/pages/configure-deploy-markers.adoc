...
+
--
Follow the steps in-app to get set up. For more infomation on the process, see the xref:set-up-rollbacks.adoc#set-up-a-rollback-pipeline[Set up a rollback pipeline] guide which includes the same process.
--
Multiple projects::
+
--

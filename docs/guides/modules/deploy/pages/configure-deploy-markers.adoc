...
. Use the dropdown menu to choose your environment integration type. Choose the 'Custom' option to follow along with this guide. Choose 'Kubernetes Cluster' if you are deploying to your Kubernetes cluster and want to use the CircleCI release agent, then head over to the xref:set-up-circleci-deploys.adoc[Set up the CircleCI Release Agent] page.
...
* xref:set-up-smart-deployments.adoc[Set up Smart Deployments] to add deploy validation and automatic rollback.

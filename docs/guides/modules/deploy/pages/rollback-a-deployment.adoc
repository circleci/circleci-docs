...
Both methods above are manual: someone notices a problem and triggers the rollback. With deploy validation configured, CircleCI can detect the problem and roll back on its own.

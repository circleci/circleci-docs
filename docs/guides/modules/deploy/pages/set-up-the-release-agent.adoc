...
. Select the gear icon image:guides:ROOT:icons/settings.svg[settings icon] corresponding to the environment you just created to enter the Environment Integration Settings page.

...
+
--
NOTE: The Generate with AI option requires AI features to be enabled for your organization. If AI features are not enabled, or if your organization uses a standalone GitHub App, you are presented with a configuration template that you can copy and use to update your configuration manually. An organization admin can enable AI features by navigating to menu:Organization Settings[Advanced]. For more details, see the xref:toolkit:intelligent-summaries.adoc[Intelligent Summaries] page.
...
For steps to running a deploy pipeline, see the xref:deploy-a-component.adoc[Deploy a Component] guide.

...
TIP: If you deploy to multiple environments (for example, dev, staging, production), you can set up an environment hierarchy to define your promotion path and use version promotion to move versions through each stage with one click. See the xref:environment-hierarchy-and-version-promotion.adoc[Environment Hierarchy and Version Promotion] guide.

...
NOTE: To set up deploy pipelines you must install the CircleCI GitHub App into your organization. For more information, see the xref:permissions-authentication:users-organizations-and-integrations-guide.adoc[Users, Organizations, and Integrations Guide].
...
. You can select btn:[Generate config change with AI] to auto-generate a new configuration file with deploy markers and then create a pull request to update your config file.
+
...
.. Copy the generated commands using the btn:[Copy] button and paste them into your existing config file in your repository where the deployment occurs.
+
...
#image::guides:ROOT:deploy/rollback-execution-modal.png[Deploy execution modal]#ß
+

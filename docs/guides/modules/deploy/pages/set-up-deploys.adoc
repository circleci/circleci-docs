...
. In the Deploy Pipeline section, choose the pipeline you want to be selected as the deploy pipeline from the dropdown. Youc an also choose the _unset_ the deploy pipeline at this point which will enable you to use the guided setup again as described above.

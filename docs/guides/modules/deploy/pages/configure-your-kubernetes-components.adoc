...
* Set up your environment integration. Refer to the xref:set-up-the-circleci-release-agent.adoc[Set up the CircleCI release agent] page.
* Install the CircleCI release agent into your Kubernetes cluster. Refer to the xref:set-up-the-release-agent.adoc[Set up the release agent] page.
...
+
image::guides:ROOT:project-id.png[Screenshot showing where to find the project ID]
****
...
In this tutorial you have configured your Kubernetes components for visibility and control from the CircleCI deploys dashboard. Next, learn how to manage your deploys in the xref:manage-deploys.adoc[Manage deploys] how-to guide.

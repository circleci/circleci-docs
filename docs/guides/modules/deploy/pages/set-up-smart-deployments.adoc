...
The URL is the same for every webhook secret in your organization. You can copy the full URL, with your organization ID already filled in, from the guided setup or from your organization deploy settings.

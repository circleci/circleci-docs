...
Smart Deployments is the CircleCI continuous validation feature. For what it does, how the release validation engine works, and the concepts behind it, see the xref:smart-deployments-overview.adoc[Smart Deployments Overview] page.

...
For the steps to configure validation and connect your monitoring tool by hand, see the xref:set-up-release-validation-manually.adoc[Set up Release Validation Manually] guide. This page is the field reference for that work.

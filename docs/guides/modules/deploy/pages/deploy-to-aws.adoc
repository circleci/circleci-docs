...
:page-description: This document provides examples of deploying to Amazon Web Services.
:experimental:
...
Deploy markers provide a way to track and manage your AWS deployments in the CircleCI web app. Deploy markers work with all AWS deployment types including S3, ECR, ECS, and CodeDeploy. When you add deploy markers to your deployment job, you can view a timeline of all deployments, track their status, and enable rollback and deploy pipelines.

...
`static` (default):: The agent monitors the exact namespace names listed in `managedNamespaces`, matching the behavior of earlier versions with no additional RBAC permissions required.

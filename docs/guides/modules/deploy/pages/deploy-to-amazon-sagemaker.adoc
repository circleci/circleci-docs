...
* xref:deploy:deploys-overview.adoc#[Deploys overview]
...
* A copy of the link:https://github.com/CircleCI-Public/sagemaker-deploy-examples[example repository] building on CircleCI. For steps to get the project set up, see the xref:getting-started:create-project.adoc#[Create a project in CircleCI] page.
...
+
image::guides:ROOT:deploy/add-release-environment.png[Screenshot showing option to add a new environment integration]
...
+
image::guides:ROOT:deploy/role-arn.png[Screenshot showing location of Role ARN]
...
* `CCI_RELEASE_INTEGRATION_TOKEN`: The orb connects your deployment to SageMaker with xref:deploy:deploys-overview.adoc#[CircleCI deploys]. This gives you visibility into the Endpoint Configuration Updates, and what is currently active.
...
+
image::guides:ROOT:deploy/add-env-var.png[Screenshot showing add environment variable popup]
...
image::guides:ROOT:deploy/job-approval.png[Approval job]
...
image::guides:ROOT:deploy/sagemaker-releases.png[Deploys dashboard]
...
image::guides:ROOT:deploy/sagemaker-component-view.png[Deploys component view]
...
image::guides:ROOT:deploy/wait-for-availability.png[Deploys version view]

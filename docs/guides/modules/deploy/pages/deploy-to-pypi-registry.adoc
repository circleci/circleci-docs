...
For a functional example you can clone and adapt, see the link:https://github.com/CircleCI-Public/sign-and-publish-examples[CircleCI sign and publish examples].

...
Artifactory has documentation explaining how to use their link:https://docs.jfrog.com/integrations/docs/jfrog-api[REST API].
...
* link:https://docs.jfrog.com/integrations/docs/maven-artifactory-plugin[Deploying with Maven]
* link:https://docs.jfrog.com/integrations/docs/artifactory-gradle-plugin[Deploying with Gradle]

[#jfrog-cli]
== JFrog CLI

If you want to use the link:https://docs.jfrog.com/integrations/docs/jfrog-cli[JFrog CLI], you can install it by following the steps below.

[#add-jfrog-to-your-configuration]
=== 1. Add JFrog to your configuration

You can install JFrog CLI in one of a few ways. Refer to the link:https://docs.jfrog.com/integrations/docs/jfrog-cli-quick-start[JFrog documentation] for the method best suited for your pipeline.
...
Deploy markers provide a way to track and manage your Artifactory deployments in the CircleCI web app. When you add deploy markers to your deployment job, you can view a timeline of all artifact uploads, track their status, and enable rollback and deploy pipelines.

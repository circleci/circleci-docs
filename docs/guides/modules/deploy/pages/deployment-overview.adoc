...
Deployment and release data in the deploys UI follows your plan's data retention policy. This data includes the timeline, component and environment details pages, and release agent commands:

...
== Deploys tracking and management

CircleCI deploys gives you visibility into your deployments within the CircleCI web app.
When setting up deploys with CircleCI you will add CLI commands to your pipeline config to enable markers to log and track deployment status in the CircleCI UI. You can also use rollbacks to rollback to a previous version of a component.

If you are deploying to Kubernetes you can choose to use the CircleCI <<release-agent-overview,release agent>>, which you install in your cluster to enable you to manage your deployments through CircleCI.
...
The sections below explain some key software delivery concepts. Understanding these concepts will help you take full advantage of CircleCI deploys and the release agent.

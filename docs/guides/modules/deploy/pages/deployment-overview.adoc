...
Alternatively, if you are deploying to Kubernetes, you can also use the CircleCI release agent to manage your deployments.
...
* xref:configure-deploy-markers.adoc[Configure CircleCI Deploy Markers] - This is a guide to configuing deploy markers manually which you can do at any time. This page is also useful as a reference when using the guided setup process defined in the guides linked above.
...
+
--
With deploy markers set up you have access to the *rollback* command which allows you to trigger a specific rollback pipeline to get back to a working version of your application quickly.

.Screenshot showing the rollback command option from project overview page
image::guides:ROOT:deploy/project-overview-rollback.png[Screenshot showing the rollback command]
--
Release agent commands::
+
--

...
* xref:deploy-validation-reference.adoc[Deploy Validation Configuration Reference]: Configure deploy validation by editing your configuration file directly.

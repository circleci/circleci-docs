...
Once you have deploy markers configured you can set up and use *rollback pipelines* to manually revert your application to a previous stable version directly from the CircleCI web app.

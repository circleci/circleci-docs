...
If you are deploying to Kubernetes you can choose touse the CircleCI *release agent*. The release agent is installed in your cluster to enable you to manage your deployments through CircleCI.

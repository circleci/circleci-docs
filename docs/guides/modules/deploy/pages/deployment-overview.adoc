...
* xref:configure-deploy-markers.adoc[Configure CircleCI Deploy Markers] - This guide covers configuing deploy markers manually which you can do at any time. This page is also useful as a reference when using the guided setup process defined in the guides linked above.

...
The release agent is the option for teams who want Kubernetes-native controls or progressive delivery. To gate releases on health without installing anything in your cluster, use Smart Deployments instead. See the xref:smart-deployments-overview.adoc[Smart Deployments Overview] page.

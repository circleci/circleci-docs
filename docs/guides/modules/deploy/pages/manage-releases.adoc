...
Use the btn:[Retry Version] action to retry a Rollout that has failed. For more information about this action, see link:https://argo-rollouts.readthedocs.io/en/latest/generated/kubectl-argo-rollouts/kubectl-argo-rollouts_retry/[Argo Rollout retry].

.Retry version button
image::guides:ROOT:releases/retry-release.png[Screenshot showing the retry version button]

...
* xref:set-up-circleci-deploys.adoc[Tutorial 2: Set up CircleCI deploys environments]
* xref:configure-your-kubernetes-components.adoc[Tutorial 3: Configure your Kubernetes components]
* xref:manage-deploys.adoc[How-to: Manage deploys]

To get set up with deploys for Amazon SageMaker, refer to the xref:deploy-to-amazon-sagemaker.adoc[Deploy to Amazon SageMaker] page.
...
** Access settings for each environment image:guides:ROOT:icons/settings.svg[settings icon].
...
** Access setting for each component image:guides:ROOT:icons/settings.svg[settings icon].
...
. Select the cog icon image:guides:ROOT:icons/settings.svg[settings icon] for your component. You can use the filter at the top of the page to help find the component you want.
. You are now on the component settings page. Select the edit button image:guides:ROOT:icons/edit-solid.svg[edit icon] in the labels panel.
...
. Select the cog icon image:guides:ROOT:icons/settings.svg[settings icon] for your environment.
. You are now on the environment settings page. Select the edit button image:guides:ROOT:icons/edit-solid.svg[edit icon] in the labels panel.
. Enter or edit your label(s) and select btn:[Done].
...
* If you decide you would like to manually configure a deploy marker for an environment integration that was created as part of an automatically detected deploy, refer to the xref:configure-deploy-markers.adoc[Configure deploy markers] page to set up a deploy marker and a new environment integration.
...
.. Find your environment and select cog icon image:guides:ROOT:icons/settings.svg[settings icon] to enter the environment integration settings page.
.. Select **Edit**.
...
. Find your project in the list, select the ellipsis image:guides:ROOT:icons/more.svg[more icon], select **Project Settings**.
. Select **Deploys**.
. Toggle the "Enable automatic deploy marker detection" option left. You will see a confirmation message in the bottom right hand corner of the app. To re-enable the feature, toggle the option to the right.
...
If you would rather set up deploy markers yourself, see the xref:configure-deploy-markers.adoc[Configure deploy markers] page.
...
* xref:set-up-circleci-deploys.adoc[Set up CircleCI deploys]

...
* A project building on CircleCI that deploys to your Kubernetes cluster or SageMaker service. See the xref:getting-started:create-project.adoc#[Create a project] page for steps.

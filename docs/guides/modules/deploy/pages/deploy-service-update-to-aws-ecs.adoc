...
TIP: When using orbs, check the link:https://circleci.com/developer/orbs[Orb Registry] to confirm you are using the most recent version. Alternatively, use the version that best fits your project.
...
* Retrieve the link:https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_definitions.html[task definition] that was previously deployed.

...
The container runner Helm chart is hosted in the link:https://github.com/CircleCI-Public/container-runner-helm-chart[container-runner-helm-chart repository]. You can find a full link:https://github.com/circleci-public/container-runner-helm-chart#values[chart values reference] section in the README.
...
* Container agent runs as PID 1 in the primary task container and currently does not support custom init processes.

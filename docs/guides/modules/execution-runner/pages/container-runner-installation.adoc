...
include::guides:ROOT:partial$runner/container-runner-prereq.adoc[]
...
Refer to the xref:troubleshoot-self-hosted-runner.adoc#container-runner[Troubleshoot Container Runner] section of the Troubleshoot Self-hosted Runner guide if you encounter issues installing or running container runner.

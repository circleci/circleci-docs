...
Refer to the xref:troubleshoot-self-hosted-runner.adoc#machine-runner[Troubleshoot Machine Runner] guide if you encounter issues installing or running machine runner on Windows.

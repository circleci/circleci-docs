...
[TIP]
====
Replace `$CIRCLE_TOKEN` with a xref:toolkit:managing-api-tokens.adoc[Personal API Token].
Replace `$CIRCLE_HOST` with your CircleCI hostname (`https://circleci.com` for Cloud, or your Server domain name).
====

...
* Alternatively, you can use the logic statement syntax to achieve the same result:
+
[,yaml]
----
include::ROOT:example$logic-statement-examples/workflow-when/or-equal-legacy.yml[]
----
...
----
+
Or using the logic statement syntax:
+
[,yaml]
----
include::ROOT:example$logic-statement-examples/workflow-when/exclude-branch-legacy.yml[]
----
...
[,yaml]
----
include::ROOT:example$logic-statement-examples/workflow-when/and-multiple-legacy.yml[]
----

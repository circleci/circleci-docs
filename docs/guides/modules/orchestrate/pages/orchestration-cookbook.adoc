...
[,yaml]
----
include::ROOT:example$logic-statements/workflow-when/or-equal-legacy.yml[]
----
...
[,yaml]
----
include::ROOT:example$logic-statements/workflow-when/exclude-branch-legacy.yml[]
----
...
[,yaml]
----
include::ROOT:example$logic-statements/workflow-when/and-multiple-legacy.yml[]
----

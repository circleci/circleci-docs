...
. Set up a GitHub App pipeline you want to trigger when a PR is marked ready for review. Steps for setting up a pipeline are available in the xref:pipelines.adoc#add-or-edit-a-pipeline[Pipelines and triggers overview] page.
+
.Add pipeline options for GitHub App
image::guides:ROOT:add-pipeline.png[Add pipeline options for GitHub App]
. Set up a trigger for your pipeline and select *PR marked ready for review* under the *Run on* menu. Steps for setting up a trigger are available in the xref:pipelines.adoc#add-a-trigger[Pipelines and triggers overview] page.
+
.Run on trigger options for GitHub App triggers
image::guides:ROOT:triggers/run-on-open.png[Run on trigger options for GitHub App triggers]
...
+
include::guides:ROOT:partial$tips/check-github-type-org.adoc[]
...
.Add pipeline options for GitHub App
image::guides:ROOT:add-pipeline.png[Add pipeline options for GitHub App]
. Set up a trigger for your pipeline and select *PR merged* under the *Run on* menu. Steps for setting up a trigger are available in the xref:pipelines.adoc#add-a-trigger[Pipelines and triggers overview] page.
+
.Run on trigger options for GitHub App triggers
image::guides:ROOT:triggers/run-on-open.png[Run on trigger options for GitHub App triggers]
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/or-equal-dynamic.yml[]
----

=== Notes

include::guides:ROOT:partial$using-expressions/env-vars-in-conditional-caveat.adoc[]

* Alternatively, you can use the classic/legacy syntax to achieve the same result:
+
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/or-equal-legacy.yml[]
----
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/exclude-branch-legacy.yml[]
----

include::guides:ROOT:partial$tips/trigger-pipeline-with-parameters.adoc[]
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/boolean-dynamic-syntax.yml[]
----
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/boolean-short-syntax.yml[]
----
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/and-multiple-legacy.yml[]
----
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-unless-steps/when-step-nested.yml[]
----
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/expression-based-job-filters/multiple-or.yml[]
----
...
[,yaml]
----
include::guides:ROOT:example$logic-statement-examples/when-in-workflows/pr-synced-or-labeled.yml[]
----

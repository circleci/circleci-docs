...
[,yaml]
----
include::ROOT:example$legacy-logic-statements/workflow-when/or-equal-legacy.yml[]
----
...
[,yaml]
----
include::ROOT:example$legacy-logic-statements/workflow-when/exclude-branch-legacy.yml[]
----
...
[,yaml]
----
include::ROOT:example$legacy-logic-statements/workflow-when/and-multiple-legacy.yml[]
----
...
[,yaml]
----
include::ROOT:example$legacy-logic-statements/step-when/when-step-nested.yml[]
----

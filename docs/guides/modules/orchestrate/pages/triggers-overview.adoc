...
#TODO Cursor Origin is missing from this section. Confirm whether Origin pipelines support manual triggering from the web app, and whether they have a separate checkout source to select. Both questions are already tracked against the Origin cells in the VCS integration overview feature table.#

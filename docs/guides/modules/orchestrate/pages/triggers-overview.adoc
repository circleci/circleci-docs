...
. Select the pencil image:guides:ROOT:icons/edit-solid.svg[edit icon] edit icon next to the trigger you want to update.,
...
.. Find your project.
.. Select the ellipsis menu image:guides:ROOT:icons/more.svg[more icon] and choose **Project Settings**.

...
.. You are in project settings if you are following these steps in sequence. If not see previous steps to get there. Select *Project Setup* in the sidebar (or **Pipelines** if you are using Bitbucket Cloud) in the sidebar.

...
[tabs]
====
GitHub, Bitbucket, and Cursor Origin::
+
--
This method is supported for GitHub (OAuth and App), Bitbucket (Cloud and Data Center), and Cursor Origin orgs.
...
NOTE: Custom webhooks are available for projects integrated via the GitHub App or Cursor Origin. Custom webhooks are not available on CircleCI Server.

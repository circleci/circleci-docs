...
In order to follow this how-to guide you will need a CircleCI configuration file for your consumer pipeline. This file will define the steps you want to run when the library changes.
...
In the configuration file for your consumer pipeline, add tag filters to your workflow. Here is an example:

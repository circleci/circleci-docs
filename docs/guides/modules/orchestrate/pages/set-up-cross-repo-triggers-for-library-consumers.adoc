...
There are two options in this how-to guide for managing the configuration file for the consumer pipeline. You can either store the config in the consumer repository or in a centralized config repository:

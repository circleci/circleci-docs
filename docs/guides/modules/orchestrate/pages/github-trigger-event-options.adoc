...
|The pull request comment body, if a pipeline was triggered through the preset "PR comment is exactly 'run-ci'". For pipelines triggered in other ways, this value is undefined.
|===

...
. Find your project in the list, select the ellipsis image:guides:ROOT:icons/more.svg[more icon] next to it and choose **Project Settings**.
...
** Authorize your connection if this is not already showing with a check mark image:guides:ROOT:icons/passed.svg[passed icon].

...
=======
If your config contains a logical statement referencing any of the pipeline values listed in the table below, you must do one of the following to prevent the pipeline creation from failing:

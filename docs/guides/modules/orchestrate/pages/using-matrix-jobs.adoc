...
Matrix jobs provide a way to run a job multiple times with arguments that are supplied using parameters. An example of this is configuring testing on multiple operating systems and against different language or library versions.
...
For full details of the matrix jobs specification, see the xref:reference:ROOT:configuration-reference.adoc#matrix[Configuration Reference].

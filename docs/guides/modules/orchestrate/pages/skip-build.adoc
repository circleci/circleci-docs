...
NOTE: **In-progress workflows are not affected.** Workflows that are already running when you enable this setting continue until they complete, fail, or are cancelled.

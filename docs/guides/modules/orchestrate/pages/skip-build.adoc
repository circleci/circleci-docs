...
For a step-by-step order of operations during an incident (block new pipelines, stop building to cancel running work, and coordinating followers), see xref:orchestrate:pause-pipelines-during-an-incident.adoc[Pause or stop pipelines during an incident].

...
To verify your trigger is set up correctly, push a commit to your repository. Remember that your config file must already be committed to the repository, because CircleCI cannot commit it for you.
--
Scheduled::
+
--

...
These steps also apply to GitHub Enterprise Server pipelines. See the xref:integration:github-enterprise-server-integration.adoc[GitHub Enterprise Server Integration] page for more information.

...
To access the form for specifying a schedule for a trigger, navigate to the following page:

* menu:Project Settings[Project Setup] if you are using GitHub.
* menu:Project Settings[Triggers] if you are using Bitbucket Cloud.

image::guides:ROOT:pipelines-scheduled-trigger-form.png[Schedule triggers web app form]

The form allows you to schedule a trigger to run weekly or monthly. The weekly option (shown above) allows you to select specific days of the week. The monthly option allows you to select specific days of the month's calendar. With either option, you then specify which months of the year you would like the trigger to repeat.

...
:page-platform: cloud
:page-vcs: github, github-enterprise, bitbucket
...
NOTE: This feature is not supported for GitLab pipelines.
...
Before you can create a new schedule, interpret the frequency your trigger needs to run from the `cron` expression. Once you have these details, create a schedule via either the API or project settings in the CircleCI web app. Both methods are described below.

...
* Ongoing pricing covers your current usage, but you can backdate it to the start of your contract.
* Historical pricing for backfilling is an optional section that you can use if you have had different contracted USD per credit agreements over the time you have used CircleCI.

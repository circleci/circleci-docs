...
If your jobs use the Docker executor and you find that they are "preparing" for quite some time, you may be able to reduce the delay. Try using more recent Docker images. See xref:execution-managed:building-docker-images.adoc[Building Docker Images] for more information.

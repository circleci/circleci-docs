...
Organizations on the Free Plan receive 30,000 credits per month for personal (non-open-source) usage, along with an included allotment of 1 GB of network transfer and 2 GB-months of storage. Network and storage usage beyond these allotments draws from your monthly credits rather than being billed separately.

When your available credits reach 0, personal builds are blocked until your credits refill at the start of the next month. There is no mid-cycle refill. Open source builds are not subject to this block and continue to run even if your credit balance is exhausted.

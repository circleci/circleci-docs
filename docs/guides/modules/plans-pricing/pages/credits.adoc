...
If your jobs use the Docker executor and stay in the "preparing" state for a while, try using more recent Docker images. See xref:execution-managed:building-docker-images.adoc[Building Docker Images] for more information.

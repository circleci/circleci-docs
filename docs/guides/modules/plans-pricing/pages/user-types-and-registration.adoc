...
* Re-running jobs in the CircleCI web application, including SSH debugging, as described on the xref:guides:execution-managed:ssh-access-jobs.adoc[Debug Jobs With SSH Rerun] page.
* Approving on-hold jobs, as described in the xref:guides:orchestrate:workflows.adoc#holding-a-workflow-for-a-manual-approval[Hold a Workflow for a Manual Approval] section. The approver is considered the actor of all downstream jobs.
...
If you or your team members are currently unregistered users (triggering builds without a CircleCI account), see the xref:guides:getting-started:first-steps.adoc[Sign up and Try CircleCI] page for instructions.
...
. *Send invites*:
+
Navigate to menu:Organization Settings[People] and use the btn:[Invite] button to send email invitations to team members. See the xref:guides:getting-started:invite-your-team.adoc#invite-teammates[Invite Your Team] section for detailed steps.
...
* xref:guides:getting-started:invite-your-team.adoc[Invite Your Team]

...
.Project dashboard
image::guides:ROOT:CircleCI-2.0-setup-project-circle101_cloud.png[Project dashboard]
...
For `circleci` type organizations, roles are set at the organization and project level. They are separate to permissions and roles set in the version control system in which your code is stored. The available roles are:

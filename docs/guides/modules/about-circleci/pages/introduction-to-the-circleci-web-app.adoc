...
Select the ellipsis menu icon image:guides:ROOT:icons/more.svg[more icon] in a project row to access project assets, as follows:
...
* From a workflow or job page using the ellipsis menu image:guides:ROOT:icons/more.svg[more icon].
* From the projects page using the ellipsis menu icon image:guides:ROOT:icons/more.svg[more icon] in a project row.

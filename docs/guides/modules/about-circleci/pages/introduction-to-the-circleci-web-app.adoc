...
When viewing a single job in a pipeline, use the breadcrumbs at the top of the page. This allows you to navigate back to a job's respective workflow, pipeline, branch, or project.

...
| Notifications
| Set your individual email and web notification preferences. This includes preferences around builds, branches, and project notifications.
...
**Projects**: Allows you to see all projects associated with your organization. Choose to follow or unfollow projects, as well as xref:getting-started:create-project.adoc[Create a Project].
...
When viewing a single job in a pipeline, you can use the breadcrumbs at the top of the page to navigate back to a job's: \\
...
.Navigate pipelines using breadcrumbs
...
TIP: The options available to you will be different depending on how you integrate your code with CircleCI. See the xref:integration:version-control-system-integration-overview.adoc[VCS Integration Overview] page for more information on which features you can use for your organization or pipeline type.
...
* xref:getting-started:create-project.adoc#set-up-a-project[Set up a Project] that you are the owner of in your VCS.
...
Select the ellipsis menu icon icon:more[Ellipsis menu icon] in a project row to access project assets, as follows:
...
* From a workflow or job page using the ellipsis menu icon:more[Ellipsis menu icon].
* From the projects page using the ellipsis menu icon icon:more[Ellipsis menu icon] in a project row.
...
The following settings are available on the project settings page. If you do not see an option, this indicates it is not supported for your organization, integration or pipeline type. See the xref:integration:version-control-system-integration-overview.adoc[Version Control System Integration Overview] page for more information.
...
| Overview
| Organization ID and slug, option to rename or delete the organization. Manage technical and security contacts.
...
| Integrations
| `circleci` organizations only. Integration set up for GitLab self-managed, Bitbucket Data Center, and Cursor Origin. See the xref:integration:set-up-vcs-connections.adoc[Set up VCS Connections] page.
...
- xref:getting-started:config-editor.adoc[Using the CircleCI Configuration Editor]

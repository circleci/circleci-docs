...
| Integrations
| `circleci` organizations only. Integration set up for GitLab self-managed and Cursor Origin. See the xref:integration:set-up-vcs-connections.adoc[Set Up VCS Connections] page.

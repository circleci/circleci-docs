...
* *Line 8:* The `name` attribute provides useful information when returning warnings, errors, and output. The `name` must be meaningful to you as an action within your build process.

...
. If you have not done so already, xref:first-steps.adoc#[sign up with CircleCI] and then either create or set up a new project. You can follow the steps to connect a code repository in our xref:getting-started.adoc#[Quickstart guide].

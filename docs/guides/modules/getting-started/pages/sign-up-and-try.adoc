...
:page-platform: Cloud
:page-description: First steps for using CircleCI, covering setting up an account and creating an organization.
:icons: font
:experimental:
...
** Use the xref:guides:getting-started:invite-your-team.adoc[Find Your Team] option to connect your account to a shared org
...
** If you want to join an existing shared organization, follow the steps on the xref:guides:getting-started:invite-your-team.adoc[Join your teammates] page.
...
. Create a project to get started. Select **Get Started** in the "Create a project" card, and refer to the Create a project page for further steps.
+
[TIP]
****
...
. Invite your team by navigating to menu:Organization Settings[People]. For more information on inviting people to your org, see the xref:guides:getting-started:invite-your-team.adoc#invite-teammates[Join your teammates] page.
...
. Finally, you will be taken to your organization's pipelines dashboard in the CircleCI web app. From here, you can follow projects or trigger pipelines in projects to which you have access in your organization, or create new projects.

NOTE: If you are setting up a project for the first time, you may need to authenticate with your VCS provider. Once you have completed a one-time authentication, you will be able to set up subsequent projects in CircleCI more quickly. Refer to the Creating a Project guide for more information.

...
:platform: Cloud, Some other platform
...
NOTE: If you have integrated your code with the xref:integration:github-apps-integration.adoc[CircleCI GitHub App] the steps in this section apply to you.
...
. Set up triggers for your pipeline. A single GitHub App trigger is set up by default to build your project on every commit to your repo.
+
...
include::ROOT:partial$notes/bitbucket-data-center-closed-preview.adoc[]
...
Through creating a project and connecting your code you have set up your pipeline and a trigger. The default trigger runs your pipeline when a change is committed to your code. You can create more triggers at menu:Project settings[Triggers]. For more information.

[#set-up-a-project]
=== Set up a project

NOTE: If you authenticated CircleCI with either the, or if you use CircleCI server, the steps in this section apply to you.
...
** **Fastest**: Use a CircleCI `.circleci/config.yml` you have already committed to your repository. For guidance on creating a `config.yml` file. You will also need to specify a branch.

...
// TODO [BETA]: Add GHES to the project creation flow.
// If the flow is identical to GitHub App Cloud, add a note:
// "These steps apply to projects using GitHub Cloud or GitHub Enterprise Server."
// If there is a GHES-specific path, document the difference.

...
* Select the ellipsis image:guides:ROOT:icons/more.svg[more icon] next your project in the Pipelines or Projects dashboard and choose **Configuration File**. This opens the CircleCI configuration editor, from where you can edit and commit your `config.yml` file.

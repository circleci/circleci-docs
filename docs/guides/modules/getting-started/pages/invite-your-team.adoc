...
After setting up an organization in CircleCI, ensure your whole team get access. Understanding the different user types (registered vs. unregistered) is important for managing costs and ensuring team members have proper access. For more information, see xref:plans-pricing:user-types-and-registration.adoc[User Types and Registration].

...
Some limitations exist depending on the execution environment in your configuration.
...
jobs:
  build:
    ...
    # Primary container image where all steps run
     - image::guides:ROOT:cimg/base:2022.05
```
...
The developer hub also has a list of available CircleCI https://circleci.com/developer/orbs[orbs], which are shareable packages of configuration you can use to simplify your builds.

...
* <<github-gitlab-cursor-origin>>
* <<bitbucket-cloud>>

[#github-gitlab-cursor-origin]
=== Sign up to build GitHub, GitLab, or Cursor Origin projects

If you want to build mainly **GitHub**, **GitLab**, or **Cursor Origin** projects, sign up with your email address to create an account.

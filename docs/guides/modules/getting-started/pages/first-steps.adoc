...
For full steps on creating an organization, see the xref:create-an-organization.adoc[Create an Organization] page.
...
* If you sign up with **email and password** and add **GitHub**, **GitLab**, or **Bitbucket Data Center** to your org, you choose the VCS integration from menu:Org[VCS Connections]. You can also choose it when creating a project. You authenticate with your VCS provider as part of that setup.

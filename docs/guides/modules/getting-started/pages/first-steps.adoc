...
* If you sign up with **email and password** and add **GitHub**, **GitLab**, **Bitbucket Data Center**, or **Cursor Origin** to your org, you choose the VCS integration from menu:Org[VCS Connections]. You can also choose it when creating a project. You authenticate with your VCS provider as part of that setup.

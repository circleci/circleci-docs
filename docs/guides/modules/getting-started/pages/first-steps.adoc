...
. Visit the link:https://circleci.com/signup/[Sign Up] page.
. Select the btn:[Sign Up] button.
...
** Head straight to <<sign-up-and-create-an-org>> to create a new organization.
...
* If you sign up with **email and password** you can add the following integrations between CircleCI and your code repositories:
** **GitHub**
** **GitLab**
** **Bitbucket Data Center**
** **Cursor Origin**
+
Set up integrations from menu:Org[VCS Connections]. For steps, see the xref:integration:set-up-vcs-connections.adoc[Set up VCS Connections] page. You can also set up VCS repository integrations when _creating a project_. You authenticate with your VCS provider as part of that setup. For steps see the xref:create-project.adoc[Create a Project] page.

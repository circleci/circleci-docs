...
This guide covers creating a new organization in CircleCI. In CircleCI, an organization is a collection of projects and users.

The following organization types are available in CircleCI:

* `circleci`: This org types lets you connect to GitHub, GitLab, or Bitbucket Data Center.
...
After you create your new organization, you can start creating projects and inviting team members:
...
Once CircleCI creates your `github` organization, you can start setting up and following projects:
...
Once CircleCI creates your `bitbucket` organization, you can start setting up and following projects:

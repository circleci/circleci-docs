...
----
+
Replace `<aws-account-id>` with your 12-digit AWS account ID and `<org-id>` with your unique organization ID (found on the menu:Organization Settings[Overview] page in the link:https://app.circleci.com/[CircleCI web app]).

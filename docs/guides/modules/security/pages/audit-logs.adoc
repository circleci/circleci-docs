...
Once your request is successfully processed, select btn:[Download logs] to download the audit log as a CSV file.

NOTE: Audit log fields with nested data contain JSON blobs.

NOTE: Successful requests are available to download for 30 days.

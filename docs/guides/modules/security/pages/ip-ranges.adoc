...
In addition to AWS and GCP (see above), CircleCI's macOS cloud hosts jobs executed by machines. Here is https://circleci.com/docs/ip-ranges-list.json[list of the IP ranges] used by CircleCI macOS Cloud.

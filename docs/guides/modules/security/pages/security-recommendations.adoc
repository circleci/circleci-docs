...
This section covers several techniques to help mitigate the risks discussed above. We will focus on methods for using `curl` commands and xref:toolkit:local-cli.adoc[the CircleCI CLI] securely with the Bash shell.

...
If you have existing environment variables (or contexts) and you would like to rename your organization or repository, follow the xref:rename-organizations-and-repositories.adoc[Rename organizations and repositories] guide. The recommended steps will ensure you do not lose access to environment variables or contexts in the process.

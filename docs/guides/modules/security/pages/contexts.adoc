...
To use environment variables set within a context, the person running the workflow must be a member of the organization for which the context is set and have access to the context. The workflow must also meet any restrictions placed on the context.

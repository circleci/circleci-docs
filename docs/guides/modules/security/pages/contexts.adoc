...
If you have existing contexts (or environment variables) and you would like to rename your organization or repository, follow the xref:rename-organizations-and-repositories.adoc[Rename Organizations and Repositories] guide. mFollowing these steps will ensureyou do not lose access to contexts or environment variables in the process.
...
image::guides:ROOT:org-settings-contexts-v2.png[Contexts]

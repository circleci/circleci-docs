...
To rename a GitHub (OAuth app) or Bitbucket Cloud organization or repository connected to CircleCI, follow the steps listed below. If you do not, you may lose access to your organization or repository settings, including **environment variables** and **contexts**.

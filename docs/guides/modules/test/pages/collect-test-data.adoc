...
For custom Cucumber steps, you should generate a file using the JUnit formatter and write it to the `cucumber` directory. The following is an example of the addition to your `.circleci/config.yml` file:

...
|`none`
a| * `impacted` analyzes only tests whose impact data needs updating — either the test changed, or the files it covers changed.  This is the recommended default. +
* `none` skips analysis. +

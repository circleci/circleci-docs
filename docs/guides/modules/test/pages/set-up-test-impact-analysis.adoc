...
See <<set-up-examples>> for configuration examples of each approach. Although not listed as an example, you can even run analysis in a separate pipeline triggered on pushes to your default branch.

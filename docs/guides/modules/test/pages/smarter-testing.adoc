...
=== Get & set your CircleCI API token
...
If you're working in a git repository, the project ID will be autodetected by CircleCI. If autodetection fails or you need to specify a different project, provide the `--project-id` flag:

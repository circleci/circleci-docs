...
==== Viewing test results in the UI
 
When running tests in CI and test results are uploaded correctly, you'll see a Test Overview widget in the Tests tab on your job page. This widget displays:
 
* Total number of tests run
* Test results breakdown (passed, failed, skipped)
* Time saved from skipping tests with Smarter Testing

.Test Overview widget showing Smarter Testing results
image::guides:ROOT:test-optimization/smarter-testing-overview.png[Smarter Testing Test Overview]
...
==== Skipped & Time saved information not accurate or missing in Test Overview 

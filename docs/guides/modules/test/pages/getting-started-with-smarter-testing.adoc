...
Test unit:: The smallest unit of work your test runner can execute independently - typically a test file (for example, `tests/auth_test.py`), but can also be a test package or module.
Test suite:: A named configuration in `.circleci/test-suites.yml` that defines how to discover and run your test units.

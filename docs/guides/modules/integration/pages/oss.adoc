...
include::guides:ROOT:partial$app-navigation/steps-to-project-settings.adoc[Insert steps from selecting an organization up to the Project Settings page]
...
include::guides:ROOT:partial$notes/standalone-unsupported.adoc[This feature is not supported for GitLab, GitHub App or Bitbucket Data Center]
...
* xref:github-integration.adoc#deploy-keys-and-user-keys[Deployment keys and user keys].

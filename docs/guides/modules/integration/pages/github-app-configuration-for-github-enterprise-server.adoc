...
* **"The CircleCI App on your GitHub Enterprise Server instance is missing required permissions or event subscriptions."** See <<app-missing-permissions,The App is missing required permissions or event subscriptions>>.
* **"Your organization has not yet accepted updated permissions for the CircleCI App."** See <<org-not-accepted-permissions,Your organization has not accepted updated permissions>>.

[#app-missing-permissions]
=== The App is missing required permissions or event subscriptions

If you see the warning: **"The CircleCI App on your GitHub Enterprise Server instance is missing required permissions or event subscriptions."**
...
If you see the warning: **"Your organization has not yet accepted updated permissions for the CircleCI App."**

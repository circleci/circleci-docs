x= Using the CircleCI GitHub App in an OAuth organization
:page-platform: Cloud
...
****
Having both a GitHub App trigger *and* a GitHub OAuth trigger configured in the same project could result in duplicate builds, if you have two equivalent triggers on yoru OAuth pipeline and on a GitHub OAuth pipeline. To avoid this, you can delete the GitHub trigger from your OAuth pipeline from menu:Project Settings[Project setup].
****

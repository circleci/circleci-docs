...
* Extensive *event name* options are available, including all pushes, pull request opened, pull request merged, pull request marked ready for review, tag pushes, and more. See the full list of xref:orchestrate:github-trigger-event-options.adoc[GitHub Trigger Event Options].

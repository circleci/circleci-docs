...
#TODO The GitLab self-managed and Bitbucket Data Center tabs below say to select a "Set up integration" button next to the provider. The VCS Connections page now uses provider cards under "Available Providers". Confirm the current flow for both and update those steps.#

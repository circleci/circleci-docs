...
How you start depends on the provider. GitLab self-managed uses a btn:[Set up integration] button, while other providers are shown as cards under "Available Providers".

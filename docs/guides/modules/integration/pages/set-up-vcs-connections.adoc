...
A VCS connection links your CircleCI organization to a version control system (VCS) provider, so CircleCI can read your code and receive events from it. You manage these connections at menu:Org[VCS Connections] in the CircleCI web app.

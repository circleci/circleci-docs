...
A VCS connection links your CircleCI organization to your repositories in a version control system (VCS) provider, so CircleCI can read your code and receive events from it. You manage these connections at menu:Org[VCS Connections] in the CircleCI web app.
...
#TODO Add a screenshot of the menu:Org[VCS Connections] page, showing both the Connected and Available Providers sections. This page describes that screen entirely in prose, and no other page in the docs shows it.#

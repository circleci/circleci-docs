...
If you would like to rename your organization or repository, follow the xref:security:rename-organizations-and-repositories.adoc[Rename organizations and repositories] guide. Following these steps will ensure you do not lose access to environment variables or contexts in the process.
...
For more information, follow the xref:integration:using-the-circleci-github-app-in-an-oauth-org.adoc[Using the CircleCI GitHub App in an OAuth organization] guide.

...
. Invite your teammates to the new organization (the one that is integrated with the CircleCI GitHub App) using the instructions on xref:first-steps:invite-your-team.adoc[this page].

...
* If the motivation is to completely remove the OAuth app integration, please follow the instructionwe recommend first confirming that you do not immediately need any of the functionality listed in the <<currently-not-supported>> section below. If you have a dedicated account team at CircleCI, contact them first to discuss your migration.

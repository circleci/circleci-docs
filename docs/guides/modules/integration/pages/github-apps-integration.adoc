...
.. Select the image:guides:ROOT:icons/cancel.svg[delete icon] next to the "new" organization to remove the shared relationship between the "new" and "old" organizations.

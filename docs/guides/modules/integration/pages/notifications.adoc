...
Chunk also sends a weekly email digest every Monday summarizing your team's activity. The digest shows completed tasks, PRs opened, and failed tasks at a glance, plus a list of the most recent PRs awaiting your review. To disable the digest, scroll to the **Chunk** section in your notification settings and toggle off **Digest**.

For a full guide to setting up and using Chunk, including the weekly email digest, see the xref:guides:toolkit:chunk-setup-and-overview.adoc#weekly-email-digest[Weekly Email Digest] section of the Chunk Overview and Setup guide.

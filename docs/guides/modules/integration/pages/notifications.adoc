...
Chunk also sends an email digest every Monday summarizing your team's activity. The digest shows completed tasks, PRs opened, and failed tasks at a glance, plus a list of the most recent PRs awaiting your review. To disable the digest, scroll to the **Chunk** section in your notification settings and toggle off **Digest**.

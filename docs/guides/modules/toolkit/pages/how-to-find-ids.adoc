...
xref:reference:ROOT:variables.adoc#built-in-environment-variables[Built-in environment variables, window=_blank], scoped at the job level, include the following IDs:

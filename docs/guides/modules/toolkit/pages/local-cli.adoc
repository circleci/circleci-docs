...
CircleCI task agent:: A specialized command-line interface that retrieves and configures a task. It manages the execution of the job within a chosen compute environment.

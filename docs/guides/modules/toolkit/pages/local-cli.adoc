...
* xref:how-to-use-the-circleci-local-cli.adoc#test-splitting[Split your tests] to run across link:/docs/parallelism-faster-jobs/[parallel environments] to reduce pipeline duration

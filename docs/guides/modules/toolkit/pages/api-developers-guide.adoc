...
. xref:managing-api-tokens.adoc#creating-a-personal-api-token[Create a personal API token] by visiting the link:https://app.circleci.com/settings/user/tokens[Personal API Tokens] page, and follow the steps to add an API token

...
NOTE: The CircleCI docs MCP server uses Google or GitHub OAuth for authentication. Authentication is only for rate limiting purposes. You do not see the user's email or personal information.

...
+
If you have the legacy stable release installed (v0.1.x), uninstall it before installing the new preview version. For example, run `brew uninstall circleci`, or use the appropriate command for your operating system or package manager.

...
NOTE: The CircleCI CLI v1 is currently in preview. You should expect changes to the available commands during this phase. If you have any feedback or suggestions for the CircleCI CLI, or to report an issue, open an link:https://github.com/CircleCI-Public/circleci-cli/issues[Issue] on the GitHub repository.

...
+
If you currently have the legacy stable release installed (v0.1.x) you should uninstall this before installing the new preview version, for example, `brew uninstall circleci` or the appropriate command for your operating system and/or package manager.

...
+
If you have the legacy stable release (v0.1.x) installed, uninstall it before installing the new preview version. For example, run `brew uninstall circleci`, or use the appropriate command for your operating system and package manager.

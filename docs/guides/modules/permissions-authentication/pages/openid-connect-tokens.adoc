...
NOTE: The `oidc.circleci.com/project-id` claim is used exclusively for trust policy evaluation during the initial authentication step and is not available as a session variable after the role is assumed.

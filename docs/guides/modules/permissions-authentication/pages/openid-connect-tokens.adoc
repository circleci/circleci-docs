...
Now you have your identity provider set up, you can assign roles to your identity provider and decide how to manage the associated role(s). You can update the role permissions, using policies, to fit your use cases, or you can create roles specific to each use.

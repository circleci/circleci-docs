...
** Users must log into their email/password CircleCI account to authenticate with SSO. See the xref:sign-in-to-an-sso-enabled-organization.adoc#authenticate-with-sso-for-an-organization[Sign in to an SSO-Enabled Organization] page for more information.

...
Your organization is now using SSO to grant and deny user access. You can manage user roles by following the steps outlined on thexref:manage-roles-and-permissions.adoc[Manage Roles and Permissions] page.

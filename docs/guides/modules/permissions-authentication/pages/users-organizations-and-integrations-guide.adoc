...
To install a VCS connection, or to view, configure, or remove an existing one, see the xref:integration:set-up-vcs-connections.adoc[Set up VCS Connections] page. That page covers each provider, including what extra configuration self-managed providers need.

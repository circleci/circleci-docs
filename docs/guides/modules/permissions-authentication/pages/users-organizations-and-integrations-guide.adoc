...
*Configure*: Set up an integration with your GitLab self-managed instance from menu:Org[Integrations] as follows:
...
*Configure*: Set up an integration with your Bitbucket Data Center instance from menu:Org[Integrations] as follows:

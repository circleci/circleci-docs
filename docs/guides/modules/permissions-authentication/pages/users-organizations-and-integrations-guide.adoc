...
+
--
CircleCI uses HTTPS-based authentication to check out your code for both GitHub Cloud and GitHub Enterprise Server. No SSH keys or deploy keys are required.
--
GitHub OAuth::
+
--

...
The pipelines you can create and configure are derived from the integraiton types available to you. You can find this information in the <<organization-integrations>> section.

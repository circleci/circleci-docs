...
As a CircleCI _user_ you can access _organizations_. You can access zero, one or many organizations. You can create new organizations and/or join an existing organization.
...
Select your icon in the top bar and select **User settings** to access the following sections:
...
#Org settings table here with tabs for different org types#
...
#TODO Insert table of Project Settings for each org type#
...
#TODO GITLAB BBDC REMOVAL INSTRUCTIONS?#

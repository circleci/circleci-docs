...
The way your code is checked out when a pipeline is triggered depends on the pipeline type you have set up. The different methods are described below.

=== GitHub OAuth and Bibucket Cloud pipelines

...
| `circleci`
a| * GitHub App (add-on, available for GitHub Cloud and GitHub Enterprise Server).
* GitLab (add-on).
...
+
--
When using the GitHub App integration, CircleCI uses HTTPS-based authentication to check out your code for both GitHub Cloud and GitHub Enterprise Server. No SSH keys or deploy keys are required.
--
GitHub OAuth::
+
--

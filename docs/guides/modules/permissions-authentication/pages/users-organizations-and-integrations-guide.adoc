...
The pipelines you can create and configure are derived from the integration types available to you. You can find this information in the <<organization-integration>> section.

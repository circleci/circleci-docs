...
// TODO [BETA]: Replace this note with a reference to the self-serve setup flow
// on the GitHub Enterprise Server integration overview page.
// Also add:
// - A note about GHES authorization state being visible in User Settings (if shipped)
// - A note or screenshot showing GHES installation details in VCS Connections (if shipped)
...
+
--
*Availability*: A GitHub App integration is available for `circleci` and `github` type organizations. The CircleCI GitHub App is installed into an organization. The GitHub App integration supports both GitHub Cloud and GitHub Enterprise Server. See the xref:integration:github-enterprise-server-integration.adoc[GitHub Enterprise Server Integration] page for more information.

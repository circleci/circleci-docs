...
[.table-scroll]
--
.Integration authorization types
...
|GitHub
|GitHub App
|menu:User Settings[Account Integration]. If you are not "authorized" you will see a button in the top bar of the web app that prompts you to authorize. Managed in GitHub at link:https://github.com/settings/apps/authorizations[GitHub settings].
...
|GitLab
|TBC
|Not displayed in menu:User Settings[Account Integrations]. Managed in Gitlab at link:https://gitlab.com/-/user_settings/applications[GitLab settings].
...
* `github`: This organization type is created automatically when you authorize CircleCI to access your GitHub account via OAuth app. This happens automatically when you sign in to CircleCI with your GitHub social login. Your GitHub repositories are imported as available projects in CircleCI. You cannot create projects that do not correspond to existing repositories in your GitHub personal account or organizations.
...
You can check your organization type by navigating to menu:Organization Settings[Overview]. The start of the organization slug indicates the type of organization you have, for example `circleci`, `github`, or `bitbucket`.
...
Refer to the CircleCI documentation on xref:orchestrate:workflows.adoc#using-filters-in-your-workflows[Using Filters in Your Workflow] for information on how to build tag pushes.
--

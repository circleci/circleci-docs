...
* **Instances not scaling down** - Cloud provider API timeouts, rate limiting, or transient errors can occasionally prevent scale-in operations from completing, leaving instances running longer than expected.

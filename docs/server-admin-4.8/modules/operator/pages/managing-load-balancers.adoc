...
:page-audience: admin
:page-description: Use this guide to make the frontend load balancer private for CircleCI server v4.8.
:experimental:
...
NOTE: If you are changing this setting after the initial deployment of CircleCI Server, you may need to delete the old public load balancer. This ensures Kubernetes requests a new load balancer with the new configuration.

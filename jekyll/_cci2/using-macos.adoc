...
[WARNING]
====
*Intel-based resources reached end of life on June 28, 2024.*

The `macos.x86.medium.gen2` resource class is no longer available. The default resource class for all customers is now m1 medium.

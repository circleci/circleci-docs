...
suggested:
  ...
  - title: Intro to dynamic config
    link: https://circlecidiscuss.zendesk.com/hc/en-us/community/posts/24866672240411-Intro-to-Dynamic-Config-via-Setup-Workflows
...
Announcements about updates to these images are made in our link:https://circlecidiscuss.zendesk.com/hc/en-us/community/topics/23770998354971-CircleCI-Images[discuss community].

...
Generates and stores a cache of a file or directory of files such as dependencies or source code in our object storage. Later jobs can <<restore_cache,restore this cache>>. Learn more on the xref:caching#[Caching Dependencies] page.

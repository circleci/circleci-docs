...
There is no limit to the number of private orbs you can use to securely share across teams and groups. See <<#private-orbs, Private orbs>> below for more information.

...
Follow the steps on the link:/docs/first-steps/#github-gitlab-bitbucket-data-center[Sign Up and Try] page to connect your GitLab account with CircleCI, then follow the steps in the following sections to migrate your CI/CD setup to CircleCI.

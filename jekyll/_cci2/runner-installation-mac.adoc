...
== 2. Download the macOS launch-agent script
...
== 3. Create a CircleCI's self-hosted runner configuration
...
== 4. Update the Working Directory Permission
...
== 5. Install the CircleCI's self-hosted runner configuration
...
== 6. Create and install the `launchd .plist`

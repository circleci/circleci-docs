...
The CLI enables you to run jobs in your config with Docker. This can be useful to run tests before pushing config changes, or debugging your build process without impacting your build queue.
...
The following will run an example build on your local machine on one of CircleCI's demo applications:

...
The in-app config editor is not currently available outside the project creation process for [GitLab](/docs/gitlab-integration/) or [GitHub App](/docs/github-apps-integration) integrations.

...
=== Know Issue: Grant Admin Access to User

You should grant admin access to the first user accessing a CircleCI Server installation. Currently, there is a known issue preventing this from happening when LDAP authentication is in use.

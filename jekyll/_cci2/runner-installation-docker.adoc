...
- Server v3.x
---
= CircleCI's self-hosted machine runner installation with Docker
...
This page describes how to install CircleCI's self-hosted machine runner with the Docker executor. If you are looking to set up self-hosted runners in a private Kubernetes cluster, please visit the <<container-runner#,Container runner>> page.

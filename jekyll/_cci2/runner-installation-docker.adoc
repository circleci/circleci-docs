...
CircleCI has a new <<container-runner#,container runner>> in open preview which is the recommended approach for running containerized jobs on self-hosted runners.


[#alternative-approach]
== Alternative approach

If you cannot use the container runner linked above, you can use a VM-based self-hosted runner and install Docker on it with the instructions below.

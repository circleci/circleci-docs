...
* As part of the process to add your OpenAI credentials, you can also save the credentials for your evaluation platform, such as Braintrust and LangSmith. 
* These credentials can then be used when setting up a pipeline that uses the Evals orb.

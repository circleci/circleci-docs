...
CAUTION: The scheduled workflows feature does not support xref:dynamic-config#[Dynamic config]. You will need to use the xref:scheduled-pipelines#[Scheduled pipelines] feature. More information can be found in this link:https://support.circleci.com/hc/en-us/articles/360060833331-Support-for-Scheduled-Workflows-in-Dynamic-Configurations-Setup-Workflows[support article].

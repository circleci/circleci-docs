...
* Fixed an issue that was preventing the customization of proxy settings for Docker containers. See the [Nomad Client Proxy](https://circleci.com/docs/2.0/proxy/#nomad-client-proxy-setup) and [Service Configuration Overrides](https://circleci.com/docs/2.0/customizations/#service-configuration-overrides) guides for more infomation.

...
Runners require both a namespace and a resource class. 
...
A **resource class** is the combination of your namespace and a label you choose to represent your pool of self-hosted runners. For example, a CircleCI resource class would be `circleci/new-label`. Optionally, you can give your resource class a description. Resources classes are created when you go through the process of installing self-hosted runners.

...
Head to the CircleCI academy and take the https://academy.circleci.com/runner-course[runner course] to learn more about running jobs on your infrastructure.

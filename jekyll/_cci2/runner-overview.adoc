...
When setting up self-hosted runner, you have the option of private Kubernetes clusters with container runner, or a virtual machine execution environment with machine runner. The diagrams below illustrate how CircleCI's self-hosted runner extends our existing systems.

...
Migrating from 2.19.x to 3.x requires that you https://circleci.com/docs/2.0/server-3-operator-backup-and-restore[back up] up your 2.19 installation and then restore the data to the new Server 3.0 installation.

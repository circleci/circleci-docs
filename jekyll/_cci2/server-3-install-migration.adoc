...
. You have password-less `sudo` access on the services machine.
...
so be sure to keep your team informed of downtime.
...
* Export the data from your v2.19.x application to your v3.x installation

...
This feature is enabled by default on all projects, but access to it can be controlled **at the project level**.

* Project level settings can be found under menu:Project Settings[VS Code integration]. Toggle the "Run pipelines with unversioned config" option to **Off** to opt-out. 

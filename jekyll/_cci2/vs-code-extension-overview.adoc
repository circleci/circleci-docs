...
This feature is enabled by default on all projects. You can opt-out of this feature per project or per org. See more details under Feature Settings. 
...
Access to this feature can be controlled **at the project level** or **at the org level**.
...
* Organization level settings can be found under menu:Organization Settings[Advanced]. Toggle "Trigger pipelines with unversioned config" option to **Off** to opt-out.

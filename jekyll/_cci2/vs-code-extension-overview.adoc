...
This feature is enabled by default on all projects. You can opt-out of this feature per project. See more details under Feature Settings. 
...
Access to this feature can be controlled **at the project level**.

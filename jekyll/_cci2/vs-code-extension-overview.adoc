...
NOTE: The ability to trigger a pipeline from VS Code with a _unversioned_ config is currently in **closed preview**. This feature is available on the **Free and Performance Plans** for projects integrated through the **GitHub OAuth app**, or **Bitbucket**. To find out which GitHub account type you have, see the xref:github-integration#[GitHub OAuth app integration] page. If you are on the Scale plan, and would like to sign up for the closed preview, you can do so link:https://docs.google.com/forms/d/1IDOyltcRRN0g5XULRK7qIzmF2Mvb5fnclk9If38_9yI/edit[here].
...
* You must be on the link:https://circleci.com/pricing/[Free plan] or link:https://circleci.com/pricing/[Performance plan]
...
You can opt-out of this feature per project. For your project, navigate to menu:Project Settings[VS Code integration] and toggle the "Run pipelines with unversioned config" option to **Off**.
====

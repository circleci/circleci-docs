...
NOTE: Currently only the **Config Helper** is available for GitLab and GitHub apps projects. To find out if you authenticated through GitHub OAuth or GitHub apps, see the xref:github-apps-integration#[GitHub apps integration] page.

...
This helper function accepts project ids and context names, and prevents the usage of **any** context **not** in the contexts allow-list, for **all** projects that are **in** the projects allow-list.
...
This helper function accepts project ids (`PROJECTS`) and context names (`BLOCKED_CONTEXTS`), and prevents the usage of **any** context **in** `BLOCKED_CONTEXTS` for **all** projects that are **in** `PROJECTS`.
...
This helper function accepts project ids (`PROJECTS`) and context names (`RESERVED_CONTEXTS`), and prevents the usage of **any** context **in** `RESERVED_CONTEXTS` for **all** projects that are **not in** `PROJECTS`.
...
This helper function accepts project ids (`BRANCHES`) and context names (`RESERVED_CONTEXTS`). Branches **not in** `BRANCHES` are prevented from using **any** context **in** `RESERVED_CONTEXTS`.

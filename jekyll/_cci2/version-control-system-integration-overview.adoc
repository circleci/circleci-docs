...
+
include::../_includes/partials/notes/bitbucket-data-center-closed-preview.adoc[]
...
| xref:status-updates#[Status Updates] 
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
| [.circle-green]#**Yes**#
...
^3^ _When Github Checks are enabled we automatically disable Github status updates to avoid duplication of statuses._

^4^ _BitBucket Cloud status can be disabled via project settings._

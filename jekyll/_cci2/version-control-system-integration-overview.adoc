...
7+^|**Code Checkout and Repository Integration**
...
| icon:thumbs-up[role="circle-green"]
| icon:thumbs-down[role="circle-red"] (possible using dynamic configuration)
| icon:thumbs-down[role="circle-red"] (possible using dynamic configuration)
| icon:thumbs-down[role="circle-red"] (possible using dynamic configuration)
| icon:thumbs-down[role="circle-red"] (possible using dynamic configuration)
| icon:thumbs-down[role="circle-red"] (possible using dynamic configuration)
...
7+^|**Pipeline Triggers and integrations**

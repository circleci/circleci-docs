...
Before deploying to Google Cloud Platform, you will need to authorize the Google Cloud SDK and set default configuration settings. Refer to the <<google-auth#,Authorizing the Google Cloud SDK>> document for full details.

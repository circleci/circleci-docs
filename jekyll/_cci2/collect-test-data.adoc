...
To integrate with CircleCI's test results features you will need to covert your Xcode Test Result bundle to the JUnit XML format.

To convert your Xcode Test Result bundle you can use a third part tool, for example, link:https://fastlane.tools/[Fastlane] or link:https://github.com/xcpretty/xcpretty[xcpretty]. Once your test results are converted you can use `store_test_results` to upload the results to CircleCI.

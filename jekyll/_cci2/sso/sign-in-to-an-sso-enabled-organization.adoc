...
NOTE: SAML Single Sign-On for CircleCI is currently in preview for Scale Plan customers. See xref:./overview#prerequisites-and-limitations[Prerequisites and Limitations]

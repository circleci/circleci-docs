...
NOTE: SAML Single Sign-On for CircleCI is currently in preview for Scale plan customers. Please see xref:./overview#prerequisites-and-limitations[Prerequisites and Limitations]
for further details. Submit feedback to: https://circleci.canny.io/identities-permissions/p/single-sign-on-sso.

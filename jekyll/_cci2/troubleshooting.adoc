...
To download a support bundle, select **Support** from the Managment Console menu bar, and then select **Download Support Bundle**. Often CircleCI support engineers will request support bundles to help diagnose/fix the problem you are experiencing.

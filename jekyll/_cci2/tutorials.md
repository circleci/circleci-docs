...
circleci image-builder | Uses Docker for building container images. | https://github.com/circleci/image-builder/blob/master/README.md[.circleci/config.yml](https://github.com/circleci/image-builder/blob/master/.circleci/config.yml)
{: class="table table-striped"}

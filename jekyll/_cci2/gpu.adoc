...
To avoid start up time associated with the above steps, they may be included in an AMI by following the instructions in the <<vm-service#vmservice,Configuring VM Service>> documentation.

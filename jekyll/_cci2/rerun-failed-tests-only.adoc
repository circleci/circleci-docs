...
Note that the `halt` command will execute the rest of the step.  Therefore, the command to execute tests should be placed in a new step after the evaluation of whether tests.txt has content or not.

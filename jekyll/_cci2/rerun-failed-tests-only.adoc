...
If your workflow has an approval job and a failed job that contains failed tests that you wish to rerun, you will not be able to click the "Rerun failed tests" option until the workflow has terminated.  This means that you must cancel the approval job before you can click "Rerun failed tests". 

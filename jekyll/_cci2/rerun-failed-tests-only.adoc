...
If you'd like to maximize credit savings, you can immediately check for whether the parallel container/VM will execute tests as the first step in a job and if there are no tests to run, terminate execution.  An example:

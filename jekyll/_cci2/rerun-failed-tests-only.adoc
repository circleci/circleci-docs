...
. Ensure that you are using the latest version of Playwright.  Version 1.27.1 of Playwright does not output JUnit XML in a format that is compatible with this feature.
...
**Question:** The re-run appears to be running all tests instead of only failed tests?

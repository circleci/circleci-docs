...
** Follow the instructions to setup SSH access.
** Tell CircleCI where your code is stored.
** Click **Create Project** at the bottom of the window.
** CircleCI will now automatically generate a custom configuration file based on the programming languages and frameworks detected in your selected repository. 

...
NOTE: If you authenticated CircleCI with either xref:gitlab-integration#[GitLab], or the xref:github-apps-integration#[GitHub App], the steps in this section apply to you. Follow the steps in the section that applies to you.
...
** Click **Create Project** at the bottom of the window. CircleCI will now automatically generate a custom configuration file based on the programming languages and frameworks detected in your selected repository. 
** When the custom configuration file has been generated, click **Commit and Run** to commit your custom configuration file on a new branch called 'update-circleci-config'. Alternatively, click **Review configuration file** to view the custom configuration file in the configuration editor. 

...
If you authenticated CircleCI with either xref:gitlab-integration#[GitLab], or the xref:github-apps-integration#[GitHub App], the steps in this section apply to you. Follow the steps in the section below that applies to you.

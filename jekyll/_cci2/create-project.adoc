...
. Next you will set up the following:
...
+
Follow the steps on the xref:bitbucket-data-center-integration#steps-to-integrate-bitbucket-data-center-projects-with-circleci[Bitbucket integration setup] page.
--

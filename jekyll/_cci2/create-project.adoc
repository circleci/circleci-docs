...
. Choose a repo to connect to your project. If you do not see your repo listed, select btn:[Add] to access repositories from GitLab Cloud. Select btn:[GitLab Cloud] and then btn:[Authorize in GitLab]
+
image::create-project/choose-a-repo.png[Choose a repository window with option to add another VCS]
...
. Choose a repo to connect to your project. If you do not see your repo listed, select btn:[Add] to access repositories from Bitbucket Data Center. Select btn:[Bitbucket Data Center] and then btn:[Authorize in Bitbucket Data Center]
+
image::create-project/choose-a-repo.png[Choose a repostory window with option to add another VCS]

...
----
orbs:
  aws-ecr: circleci/aws-ecr@9.0.2 # use the AWS ECR orb
  aws-ecs: circleci/aws-ecs@4.0.0 # use the AWS ECS orb
  aws-cli: circleci/aws-cli@4.1.2 # use the AWS CLI orb
----

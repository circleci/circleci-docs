...
WARNING: This feature is in **Preview**, use at your own risk. For questions and/or issues, please comment on our link:[Community forum] (add link).
...
Now in preview is a new functionality to fail tests faster. You can configure your testing jobs to stop executing shortly after finding the first test failure.
...
If no test splitting is enabled, batches execute sequentially as shown in the diagram shows below.

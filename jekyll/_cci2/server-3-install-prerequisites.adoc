...
. If you are using AWS Route53 for DNS, you will need the *certbot-route53* plugin. You can install the plugin with the following command:
+
```shell
...
. If you host your DNS on Google Cloud, you will need the *certbot-dns-google* plugin. You can install the plugin with the following command:
+
```shell

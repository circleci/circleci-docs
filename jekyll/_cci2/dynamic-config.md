...
Instead of manually creating an individual CircleCI configuration per project, you might prefer in some cases to generate these configurations dynamically, depending on specific [pipeline values](/docs/pipeline-variables/) or file paths.
...
4. Scroll to the **Enable dynamic config using setup workflows** setting, and toggle it to the "on" position, as shown below:
  <br>
  ![Enable dynamic config in the UI](/docs/assets/img/docs/dynamic-config-enable.png)
...
For a basic example on how to use setup workflows for dynamic configuration generation, see the [Using Dynamic Configuration](/docs/using-dynamic-configuration/) how-to guide.
...
## Next steps
{: #what-to-read-next }
- A how-to guide for [Using Dynamic Configuration](/docs/using-dynamic-configuration/)

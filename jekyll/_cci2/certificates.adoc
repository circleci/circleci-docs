...
The Replicated Management Console(`<circleci-hostname>.com:8800`) runs on a different web server, so you also need to apply the certificate used above for Replicated. To do so, follow these steps:

...
Once all the application-layer pods have finished terminating, either redeploy the update from the KOTS admin console or run the following to redeploy the pods and return server to a functional state:

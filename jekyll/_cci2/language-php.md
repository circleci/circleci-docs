...
Success! You just set up CircleCI 2.0 for a PHP app. Check out our project’s [Jobs page](https://circleci.com/gh/CircleCI-Public/circleci-demo-php-laravel){:rel="nofollow"} to see how this looks when building on CircleCI.

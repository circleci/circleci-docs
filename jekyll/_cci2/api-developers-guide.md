...
You may use the API token as the username with HTTP Basic Authentication. You can also use the token value in the request header with the name `Circle-Token`, as shown in the examples below.

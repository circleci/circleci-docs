...
Following is a full `.circleci/config.yml` that compiles the example C abort program, and collects the core dumps as artifacts.

{:.tab.fullconfig.Cloud}
```yaml
version: 2.1
jobs:
  build:

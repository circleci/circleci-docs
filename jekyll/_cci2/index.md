...
If you are a System Administrator, see the [2.0 Administrator’s Overview]({{ site.baseurl }}/2.0/overview/) document to get started and refer to the [Installing CircleCI 2.0 on Amazon Web Services with Terraform]({{ site.baseurl }}/2.0/aws/) or [Installing CircleCI 2.0 on AWS Manually]({{ site.baseurl }}/2.0/aws-manual/) documents for installation instructions.

...
# "only_allow_trusted_forked_pull_request_builds" passes only if build is triggered by a trusted fork for a defined project
only_allow_trusted_forked_pull_request_builds[reason] {
	not trusted_forks[data.meta.vcs.target_repository_url][data.meta.vcs.origin_repository_url]

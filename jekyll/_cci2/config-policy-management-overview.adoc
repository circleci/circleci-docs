...
The following is an example of a policy that blocks pull request builds from untrusted forks.
...
# list of trusted forks
# keys: projects for which trusted forks are to be defined
# values: set of trusted forks for the given project
trusted_forks := {
  "https://github.com/circleci/circleci-docs": {
    "https://github.com/trusted_org1/circleci-docs",
    "https://github.com/trusted_org2/circleci-docs"
    }
}
...
enable_rule["only_allow_trusted_forked_pull_request_builds"] { data.meta.vcs.origin_repository_url != data.meta.vcs.target_repository_url }

# enabled hard failure for "only_allow_trusted_forked_pull_request_builds" rule
hard_fail["only_allow_trusted_forked_pull_request_builds"]

# "only_allow_trusted_forked_pull_request_builds" is violated if build is triggered by an untrusted fork
only_allow_trusted_forked_pull_request_builds[reason] {
	trusted_forks_of_project := trusted_forks[data.meta.vcs.target_repository_url]
	not trusted_forks_of_project[data.meta.vcs.origin_repository_url]
	reason := sprintf("fork %s is not allowed to trigger pull request build to repo %s", [data.meta.vcs.origin_repository_url, data.meta.vcs.target_repository_url])
}
----

...
contentTags:
  ...
  - Cloud
---
= Bitbucket Integrationjkljjlkjlkjfconfi
...
If you would like to rename your organization or repository, please follow the <<rename-organizations-and-repositories,Rename organizations and repositories>> guide to make sure you do not lose access to environment variables or contexts in the process.

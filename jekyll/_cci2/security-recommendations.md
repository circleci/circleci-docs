...
* **System logs**: Many systems log all commands executed using `sudo` for auditing. There are many auditing services which record all commands; such services could potentially export those logs into systems not designed to keep secret data safe.

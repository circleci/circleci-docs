...
```
+
NOTE: This file replaces the full resource class definition for your installation so it's important you include all resource classes your users need at this point, not just those you wish to customize.

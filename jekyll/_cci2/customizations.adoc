---
description: This documentation summarizes the key files and variables that impact CircleCI server behavior, and configuration options for your server installation.
version:
- Server v2.x
- Server Admin
---

...
<<custom-images,Bash> is required for custom images used in jobs executed with a container runner.  https://circleci.com/docs/custom-images#required-tools-for-primary-containers.

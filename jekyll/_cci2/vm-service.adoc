...
. Open up your installation of CircleCI Server and set up your AWS keys as described in the image builder https://github.com/CircleCI-Public/circleci-server-windows-image-builder#setting-up-on-circleci[README].

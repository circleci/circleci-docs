...
NOTE: A cron job is scheduled to cycle all default and preallocated instances at least once per day to ensure instances do not end up in a unworkable state.

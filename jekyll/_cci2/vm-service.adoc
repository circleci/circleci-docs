...
Creating a Windows image and specifying it under the VM Service settings lets your users run jobs on dedicated Windows machines. To create your Windows image run through the following steps:
...
. Open up your installation of CircleCI Server and connect your new repo by clicking Follow Project from the Add Projects page.

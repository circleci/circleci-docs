...
To get started, go to Project Settings for one of your projects, select the "Pipelines" tab, and link:https://circleci.com/docs/pipelines/#add-or-edit-a-pipeline[add a new pipeline]. One of the key steps in creating your first pipeline will be installing the CircleCI GitHub App and connecting to it.

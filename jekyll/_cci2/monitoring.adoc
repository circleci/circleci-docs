...
. Navigate your Management Console Settings. You can use the following URL, substituting your CircleCI hostname: `https://<your-circleci-hostname>.com:8800/settings#datadog_metrics`

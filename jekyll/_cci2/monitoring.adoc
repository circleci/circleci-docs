...
// Can this just say 'metrics' rather than system and Docker metrics?
...
// what is meant by VM Host here? Does this actually mean metics for the Services Machine?
...
// Do customers get these metics in Cloudwatch/Datadog too?
...
// What is meant by Standard Output and Standard Error?

=== CircleCI Metrics
// This title isn't write I don't think, but not sure what to call them?
...
.Custom Metrics
image::metrics-custom.png[Custom Metrics]

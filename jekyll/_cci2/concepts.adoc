...
For xref:github-apps-integration#[GitHub App], xref:gitlab-integration#[GitLab SaaS and self-managed] and Bitbucket Data Center users, a _project_ in CircleCI is standalone. You name your project and then connect your code (in your GitHub, GitLab or Bitbucket Data Center repository) to that project. A standalone project can have:

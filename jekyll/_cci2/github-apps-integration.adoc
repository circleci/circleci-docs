...
* A checkout source, which determines which repository will be checked out when running a link:https://circleci.com/docs/configuration-reference/#checkout[checkout step].
This model allows your CircleCI config to be stored in a different repository from your code. 

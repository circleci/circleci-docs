...
. If you are on a paid pricing plan, go to "Plan" in the CircleCI web app and click on the "Share and Transfer" tab. Click "Transfer plan" and follow the instructions to transfer your pricing plan to your new organization by clicking on the new organization in the "transfer" UI.
. If you followed step 12, your pricing plan will now be transferred to your new organization (the one that is integrated through the CircleCI GitHub App integration).

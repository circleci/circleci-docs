...
12. If you are on a Performance pricing plan, go to "Plan" in the CircleCI UI and click on the "Share and Transfer" tab. Click "Transfer plan" and follow the instructions to transfer your pricing plan to your new organization (use "/circleci" as the VCS and the organization ID that is found in Organization Settings as the <org> if prompted).  
13. If you followed step 12, your pricing plan will now be transferred to the organization that is your "new" organization that uses the GitHub App integration. 

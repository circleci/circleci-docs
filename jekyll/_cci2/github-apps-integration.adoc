...
When you create a new organization and connect your GitHub account, you will be prompted to create a new project from a repository. After creating a new project, CircleCI will automatically generate a custom configuration file based on the programming languages and frameworks detected in your repository. You will be presented with the following options to either commit and run the generated configuration file on a new branch or view the generated configuration file in the configuration editor. 

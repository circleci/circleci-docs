...
WARNING: If you select to make the frontend load balancer private, webhooks will only work if you use using GitHub Enterprise. Webhooks will fail when using GitHub.com.

...
NOTE: *If you are installing Windows machine runners on server, continue with the steps in this section.* Otherwise, skip ahead to the xref:#installation-steps[next section].

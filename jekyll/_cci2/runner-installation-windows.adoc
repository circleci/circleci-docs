...
This page describes how to install CircleCI's machine runner on Windows for server. This has been tested for Windows Server 2019 and Windows Server 2016, both in Datacenter Edition. Other Server SKUs with Desktop Experience and Remote Desktop Services should also work.

Please note that this method is deprecated for cloud customers and see https://circleci.com/docs/install-machine-runner-3-on-windows/ for recommended Runner installation on Windows for cloud.

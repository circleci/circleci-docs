...
|-----------|-----------------|------------------------------------|---------
| Artifacts | Months          | Preserve long-term artifacts. |  Available in the Artifacts tab of the **Jobs page** under the `tmp/circle-artifacts.<hash>/container`   or similar directory.     |

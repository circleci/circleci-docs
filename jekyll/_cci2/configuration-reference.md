...
Following are possible resource classes. If `resource_class` is not specified or an invalid class is specified, the default resource class of `medium` will be used.

...
###### **`context`**
Jobs may be configured to use global environment variables set for an organization. See the [Contexts]({{ site.baseurl }}/2.0/env-vars/#contexts) section for more information.

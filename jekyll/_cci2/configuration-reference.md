...
**Note:** This feature is automatically enabled on Free and Performance plans. Available resources classes are restricted for customers on the Free plan to small/medium/large for linux, and medium for Windows. MacOS is not yet available on the Free plan.

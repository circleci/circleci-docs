...
This quickstart provides a guided tour through setting up a project and, collaborating, and then a few tools to iterate on and debug your build configuration. The following sections cover the following:
...
{% capture content %}
Select the green <b>Success</b> button to see details about a <a class="no-external-icon" href="https://circleci.com/docs/concepts/#workflows">workflow</a>. The workflow expands to show all jobs that ran.
{% endcapture %}

...
<div class="banner-wrapper">
  <div class="icon-container">
    <img class='vcs-icon' src="/assets/img/icons/companies/github-alt.svg" alt="Github Icon" />
    <img class='vcs-icon' src="/assets/img/icons/companies/bitbucket-alt.svg" alt="Bitbucket Icon" />
    <img class='vcs-icon' src="/assets/img/icons/companies/gitlab-color.svg" alt="GitLab Icon" />
  </div>
...
<div class="include-two-up">
  ...
  <div class="right-side">
    <img class="right-img" src="/assets/img/docs/getting-started-guide-exp/change-config-gitlab.png" alt="Config Editor" />
  </div>
</div>
...
<div class="include-two-up">
  ...
  <div class="right-side">
    <img class="right-img" src="/assets/img/docs/getting-started-guide-exp/commit-run-gitlab.png" alt="Commit a config" />
  </div>
</div>
...
<div class="include-two-up">
  ...
  <div class="right-side">
    <img class="right-img" src="/assets/img/docs/getting-started-guide-exp/pass-pipeline.png" alt="Passing pipeline" />
  </div>
</div>
++++
--

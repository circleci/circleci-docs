...
<div class="include-two-up">
  <div class="left-side">
    <div class="section-heading">2. VS Code extension</div>
    <p>Using the <a href="https://circleci.com/docs/vs-code-extension-overview/">CircleCI VS Code extension</a>, validate your CircleCI config file. Get help with troubleshooting config updates and help keeping dependencies up to date.</p>
  </div>

...
**Note:** To use an image with the CircleCI [Docker Executor]({{ site.baseurl }}/2.0/execution-environments/using-docker) you must have a public repository. If you want to keep your image private, refer to the [Using Docker Authenticated Pulls]({{ site.baseurl }}/2.0/private-images/) document for instructions.
...
{: #caching-docker-images }
For information on how Docker images are cached, see [Caching Docker Images]({{site.baseurl}}/2.0/execution-environments/using-docker#caching-docker-images).

...
** **Good:** Refer to the https://circleci.com/docs/2.0/env-vars-set/#set-an-environment-variable-in-a-project[Setting an environment variable in a project] section of the Environment Variables document. +
** **Bad:** See here for info on https://circleci.com/docs/2.0/env-vars-set/#set-an-environment-variable-in-a-project[adding project-level environment variables]. 

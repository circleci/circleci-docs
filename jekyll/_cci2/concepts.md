...
The example below shows how to define a resource class in the Docker execution environment. Examples for all execution environments are available on the following pages:
...
Pricing and plans information for the various resource classes can be found [here](https://circleci.com/product/features/resource-classes/).

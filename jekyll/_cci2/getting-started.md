...
For more information on the results of each step expand the steps using the little triangle on the left. ![](jekyll/assets/img/docs/CircleCI-project-setup-success-steps.PNG)

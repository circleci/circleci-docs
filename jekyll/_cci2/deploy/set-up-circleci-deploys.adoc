...
. To get set up with CircleCI releases and Amazon SageMaker from this point, follow the steps outlined on the xref:guides/deploy-to-amazon-sagemaker#[Deploy to Amazon SageMaker] page.
--

...
NOTE: **Deploy to Kubernetes?** Refer to our xref:../deploys-overview#[Releases overview] page to start managing your releases in the CircleCI web app. CircleCI releases is in open preview.
...
+
TIP: Add a release log step to your deployment job to **view a log of releases** in the CircleCI web app. See the xref:../configure-deploy-markers#[Release markers] guide to learn more.

...
* xref:set-up-circleci-deploys#[Tutorial 1: Set up CircleCI releases]
* xref:configure-your-kubernetes-components#[Tutorial 2: Configure your Kubernetes components]
* xref:manage-deploys#[How-to: Manage releases]

To get set up with releases for Amazon SageMaker, refer to the xref:how-to/deploy-to-amazon-sagemaker#[Deploy to Amazon SageMaker] page.

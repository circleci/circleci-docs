...
Visualise and control your deployments with CircleCI deploys. The CircleCI deploys dashboard and tooling currently works with deployments to Kubernetes and Amazon SageMaker.

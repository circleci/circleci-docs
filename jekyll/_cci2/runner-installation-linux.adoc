...
== 2. Download the machine runner launch-agent script
...
== 3. Create the `circleci` user and working directory
...
== 4. Create the CircleCI's self-hosted runner configuration

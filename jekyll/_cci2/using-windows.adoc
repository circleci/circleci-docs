...
CircleCI supports Windows Server 2019 with Visual Studio 2019 and Windows Server 2022 with Visual Studio 2022. For information on the software that is pre-installed on each Windows image, visit the link:https://circleci.com/developer/images?imageType=machine[Developer Hub]. CircleCI will announce changes and new images in the link:https://circlecidiscuss.zendesk.com/hc/en-us/community/topics/23770998354971-CircleCI-Images[CircleCI discuss community].
...
NOTE: The `current` tag is available for Windows images. The `current` and `stable` tags are equivalent, and are currently both supported. Refer to the link:https://circlecidiscuss.zendesk.com/hc/en-us/community/posts/24866764018075--April-2022-Windows-image-updates-available-for-stable-tags[CircleCI discuss community] for more information.

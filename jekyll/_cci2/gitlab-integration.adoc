...
This page walks you through integrating a GitLab project with CircleCI. The sections below introduce you to concepts and ways to manage your GitLab CI/CD pipelines. We also outline what we are working on for future releases.

[#sign-up]
== GitLab integration steps

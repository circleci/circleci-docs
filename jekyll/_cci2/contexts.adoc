...
You must be an organization administrator, and your code must be integrated with CircleCI via the GitHub OAuth app to us esecurity group context restrictions.

...
. You can now click on any context created in your list to add environment variables. Click on the *Add Environment Variable* button to enter the variable name and value you wish to associate with this context. Click the *Add Environment Variable* button in the dialog box to finialize.

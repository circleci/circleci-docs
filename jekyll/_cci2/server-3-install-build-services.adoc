...
NOTE: If you are switching from static JSON credentials to Workload Identity, you should delete the keys from GCP.
...
NOTE: If you are switching from static json credentials to Workload Identity, you must delete the keys from GCP in order to avoid the key misuse.

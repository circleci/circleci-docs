...
. *Configure Server*
+
Configure VM Service through the KOTS admin console. Details of the available configuration options can be found in the https://circleci.com/docs/2.0/server-3-vm-operator-service[VM Service] guide.

...
+
image::test-splitting-artifacts.png[Artifacts tab where test results can be accessed]
+
You can open up each file to see the tests that were executed, and their respective results.
+
image::test-splitting-junitxml.png[Contents of JunitXML test result file]

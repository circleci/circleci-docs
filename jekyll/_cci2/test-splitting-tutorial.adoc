...
. After you've made these changes, go ahead and click btn:[Commit and Run]. This will commit the changes in a new feature branch called `circleci-project-setup` and trigger a new pipeline. Select **Dashboard** from the web app side bar, and use the filters to find your project to watch your pipeline run.
+
...
. After you've made these changes, go ahead and click the btn:[Commit and Run]. This will commit the changes in a new feature branch called `circleci-project-setup` and trigger a new pipeline. Select **Dashboard** from the web app side bar, and use the filters to find your project to watch your pipeline run.
+
image::test-splitting-first-pipeline.png[Successful pipeline run]
+
Feel free to take a look at the steps run in the pipeline by expanding the green Success status and opening the `build-and-test` job.
...
[.tab.add_project.GitLab_/_GitHub_App]
--

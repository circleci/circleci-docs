...
High availability gives you the ability to replicate your CircleCI data and automate recovery from a single database instance failure, without downtime or service disruption. Comprehensive Installation Consult and HA Support is available with premium support. Get started by contacting your Account Executive or [opening a support ticket](https://support.circleci.com/hc/en-us/requests/new).

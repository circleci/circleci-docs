...
NOTE: Open source credits for the Free plan are not currently available for GitLab and GitHub App integrations. To find out which GitHub account typer you have, see the xref:github-apps-integration#[GitHub App integration] page.

...
Follow the instructions outlined on the <<runner-installation#,self-hosted runner installation>> page to download the container runner and run your first job. You can also use the [CircleCI web app](https://app.circleci.com/) to get started with self-hosted runners.

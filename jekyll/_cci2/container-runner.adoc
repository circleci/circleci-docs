...
Container agent is aware of Kubernetes and uses it to schedule task agents. They run in separate pods and there is a 1:Many ratio between container agent and associated task agents.

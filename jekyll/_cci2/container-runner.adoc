...
| agent.resourceClasses.token
| Self-hosted Runner Authentication Token. See "Custom Task Pod Configuration" section below
| " "

| agent.resourceClasses.spec
| Specific task pod configurations. See "Custom Task Pod Configuration" section below
| " "

...
[NOTE]
====
The link:https://circleci.com/developer/orbs/orb/circleci/ai-evals[official Evals orb] supports integrations with Braintrust and LangSmith.
...
CircleCI provides an link:https://circleci.com/developer/orbs/orb/circleci/ai-evals[official Evals orb] that simplifies the definition and execution of evaluation jobs using popular third-party tools, and generates reports of evaluation results.

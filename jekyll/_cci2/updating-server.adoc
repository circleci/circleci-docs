...
* <<3-upgrade-circleci-server-version,Install the latest version of CircleCI Server>>
...
If you are already on v2.38 you can skip the next step and move to <<3-upgrade-circleci-server-version, upgrade the CircleCI application>>

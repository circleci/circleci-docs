...
Yes, refer to the <<nomad#introduction-to-nomad-cluster-operation,Introduction to Nomad Cluster Operation>> section for details. Refer to the <<monitoring#,Monitoring Your Installation>> section for how to enable additional container monitoring for AWS.

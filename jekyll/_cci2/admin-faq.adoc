...
Yes, refer to the <<nomad#nomadintro,Introduction to Nomad Cluster Operation>> section for details. Refer to the <<monitoring#monitoring,Monitoring Your Installation>> section for how to enable additional container monitoring for AWS.

...
If you want to restrict multiple IAM roles to jobs in a specific project, you could also add another value to the condition block in each role's trust policy. 

```json
"Action": "sts:AssumeRoleWithWebIdentity",
"Condition": {
    "StringLike": {
        "oidc.circleci.com:aud": "5fad0abe-723c-11ed-a1eb-0242ac120002",
        "oidc.circleci.com:sub": "org/5fad0abe-723c-11ed-a1eb-0242ac120002/project/6b28c478-723c-11ed-a1eb-0242ac120013/user/*"
    }
}
```

In this snippet, the `AssumeRoleWithWebIdentity` action can only be called by jobs in the project `6b28c478-723c-11ed-a1eb-0242ac120013` in the `5fad0abe-723c-11ed-a1eb-0242ac120002` org.

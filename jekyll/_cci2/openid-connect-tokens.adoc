...
_Consult your cloud service's documentation for how to add an identity provider._

The https://openid.net/specs/openid-connect-core-1_0.html#Terminology[OpenID Provider] is unique to your organization. The URL is `\https://oidc.circleci.com/org/<organization-id>`, where `<organization-id>` is the UUID that represents your organization. 

You can find the UUID by navigating to **Organization Settings > Contexts** on the https://app.circleci.com/[CircleCI web app].

...
Below is an example configuration demonstrating that GCP authentication worked. The example should be adapted for your specific use case. 
```yaml
version: 2.1

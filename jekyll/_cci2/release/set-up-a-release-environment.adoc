...
* A Kubernetes cluster or SageMaker #TBC#
...
. To set up the release agent into your cluster and set up your components, follow the instructions in the setup wizard.

After completing all the steps in the wizard you will have successfully created a release environment and installed the release agent into your Kubernetes cluster and configured your Kubernetes components.

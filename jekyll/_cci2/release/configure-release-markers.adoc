...
Unless you opt out of the feature, CircleCI autodetects potential releases and creates release markers for you. This guide is for you if you would rather create release markers yourself. For more informaiton see the xref:releases-overview#[Releases overview] page.

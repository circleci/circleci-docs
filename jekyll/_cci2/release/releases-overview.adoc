...
* If you decide to manually configure a release marker for an environment integration that was created as part of an autodetected release, you can update the integration type. You do not need to create a new integration. To update the integration type, follow these steps:
.. #TODO#

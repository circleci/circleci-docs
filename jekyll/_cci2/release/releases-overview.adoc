...
CircleCI can integrate with your Kubernetes cluster to give you visibility and control over your release process through the CircleCI web app. We currently support Kubernetes Deployments and Argo Rollouts.
...
A number of features improvements are planned to be added through the open preview period and beyond:
...
* #Release job type (add releases to your workflow DAG)#
* #Analysis run results/details#
* #Improved searching, filtering and ability to pin/favorite components#

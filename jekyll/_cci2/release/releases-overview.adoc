...
Add labels to your components and environments to provide teams with a way to filter and group content in the releases UI. Once a label is added, you can use this to filter multiple components and/or environments in the UI so you can focus on the content relevant to your team.

...
This project is available on link:https://github.com/CircleCI-Public/dynamic-configuration-examples/tree/generate-config-file-main[GitHub] and you can see it building on link:https://app.circleci.com/pipelines/github/CircleCI-Public/dynamic-configuration-examples?branch=generate-config-file-main[CircleCI]. Each configuration file is explained in the following sections.

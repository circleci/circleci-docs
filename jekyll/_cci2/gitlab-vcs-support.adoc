...
Some built-in enviornment variables will not be supported on GitLag. The following built-in environment variables should be used as **pipeline parapaters** instead:

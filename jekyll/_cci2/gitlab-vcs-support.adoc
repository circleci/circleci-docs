...
We’re excited to offer a preview of GitLab VCS support. While we’re proud of what we’ve built so far, we are iterating to improve known performance issues.  At this time, we recommend not using GitLab for production of critical work.

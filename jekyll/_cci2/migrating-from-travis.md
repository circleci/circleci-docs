...
|-------------------|------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| language:,<br>os: | [docker, machine, macos, windows]({{ site.baseurl }}/2.0/executor-types/)          | Rather than making assumptions about dependencies and commands based on a language, CircleCI allows great flexibility in defining your jobs. CircleCI offers the major operating systems or Docker images as executors. Specify a Docker image with your needed prerequisites (see our [convenience images]({{ site.baseurl }}/2.0/circleci-images/#next-gen-language-images)), or use a VM and install other needed libraries. See the list of pre-installed software for [Windows]({{ site.baseurl }}/2.0/hello-world-windows/), [macOS]({{ site.baseurl }}/2.0/testing-ios/#supported-xcode-versions), and [Linux]({{ site.baseurl }}/2.0/docker-to-machine/#pre-installed-software/) images. |

...
| dist:             | [docker, machine, macos](https://circleci.com/docs/2.0/executor-types/)            | Rather than a distribution, we offer Docker, Linux VM, and MacOS execution environments              |

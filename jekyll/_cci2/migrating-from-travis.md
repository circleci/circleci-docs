...
| before_install:   | [run:](https://circleci.com/docs/2.0/configuration-reference/#run)                 | CircleCI doesn't separate commands into stages or types. Use run: steps and order them per your needs. See [documentation](https://circleci.com/docs/2.0/configuration-reference/#run) for usage of conditional steps |

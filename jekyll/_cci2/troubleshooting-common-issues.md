...
**Note:** This will be accurate if the job has one Docker image. [Multiple Docker image builds]({{site.baseurl}}/2.0/execution-environments/using-docker/#using-multiple-docker-images) will only report the memory usage of the primary image.

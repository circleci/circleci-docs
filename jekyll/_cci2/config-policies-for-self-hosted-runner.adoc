...
--
If you have set up your config policies repository with the sample configuration shown xref:create-and-manage-config-policies#manage-policies-with-your-vcs[here], push your changes to the `main` branch of your config policies repository, and head to the CircleCI web app to see your policy pipeline run.

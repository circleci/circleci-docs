...
. In the CircleCI web app, navigate to **Projects** in the sidebar, then select the ellipsis (...) next to your project and elect **Project Settings**. You can also find the **Project Settings** button on each project's landing page.

...
If you find that after following these steps, the disk size allocated to your data directories have not increased, then you may need to restart your database pods. This will cause downtime of 1-5 mins as the databases restart. You can use the commands below to restart your databases.

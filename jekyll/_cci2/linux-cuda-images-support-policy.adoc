...
** `edge` images incorporate any new changes for customers who want the latest version as fast as possible. The `edge` tag becomes available a week prior to general releases. 

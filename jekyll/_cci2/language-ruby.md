...
Success! You just set up CircleCI 2.0 for a Ruby on Rails app. Check out our [Jobs page](https://circleci.com/gh/CircleCI-Public/circleci-demo-ruby-rails){:rel="nofollow"} to see how this looks when building on CircleCI.

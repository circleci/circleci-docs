...
| キー   | 必須 | 型   | 説明                                                               |
| ---- | -- | --- | ---------------------------------------------------------------- |
| path | N  | 文字列 | Checkout directory (default: job's [`working_directory`](#jobs)) |
{: class="table table-striped"}

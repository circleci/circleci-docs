...
6. Your orb is now published in an immutable form as a production version and can be used safely in builds. You can pull the source of your orb using: `circleci orb source sandbox/hello-world@0.0.1`

...
[Stable releases](https://download.docker.com/linux/static/stable/x86_64/) - `17.03.0-ce` (default) - `17.06.0-ce` - `17.06.1-ce` - `17.09.0-ce` - `18.03.0-ce` - `18.03.1-ce` - `18.05.0-ce`

[Edge releases](https://download.docker.com/linux/static/edge/x86_64/) - `17.05.0-ce` - `17.07.0-ce` - `17.10.0-ce` - `17.11.0-ce` - `18.06.0-ce`
...
[job-space]: {{ site.baseurl }}/2.0/glossary/#job-space [primary-container]: {{ site.baseurl }}/2.0/glossary/#primary-container
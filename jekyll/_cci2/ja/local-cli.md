...
**Note:** If you installed the CLI prior to October 2018 you may need to do an extra one-time step to switch to [the new CLI](https://github.com/CircleCI-Public/circleci-cli). See upgrading and installation instructions below.

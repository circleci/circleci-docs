...
**Note:** If your *config.yml* uses Workflows and has a job named `build`, only the `build` job will run. It is not possible to run an entire workflow using the CLI.

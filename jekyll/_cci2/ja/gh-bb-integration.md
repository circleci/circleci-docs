...
3. Go to <<https://circleci.com/add-projects>{:rel="nofollow"}> and follow the projects you want the machine user to have access to.
...
**Read Permission** - Get a user's email address

**Write Permissions** - Add deploy keys to a repo - Add service hooks to a repo - Get a list of a user's repos - Add an SSH key to a user's account
...
3. Go to <https://circleci.com/gh/you/test-repo/edit#ssh>{:rel="nofollow"}, and add the key you created in step 1. In the "Hostname" field, enter "github.com", and press the submit button.

...
CircleCI requests permissions as required by the [GitHub permissions model](http://developer.github.com/v3/oauth/#scopes) and [Bitbucket permission model](https://confluence.atlassian.com/bitbucket/oauth-on-bitbucket-cloud-238027431.html#OAuthonBitbucketCloud-Scopes) as follows:
...
2. On the **Checkout SSH Keys** page, right-click the **Create <username> user key** button and select the **Inspect** option.

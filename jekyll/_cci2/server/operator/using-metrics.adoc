...
NOTE: Prometheus Server is not limited to scraping metrics from your CircleCI server install. By default, it scrapes metrics from your entire cluster. It is disabled in your installation by default but you may enable it by making change in helm value file if needed.

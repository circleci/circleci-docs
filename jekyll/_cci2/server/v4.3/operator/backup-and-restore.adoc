...
but it also restores the state of the Kubernetes cluster and its resources at the time of the backup. Setup and install of Velero is covered in the xref:../installation/phase-4-post-installation#backup-and-restore[server v4.3 post installation guide].

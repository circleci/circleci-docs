...
This page describes how to configure external services for use with either a new CircleCI server v4.3 installation or migrating internal Postgres and MongoDB data from existing CircleCI server v4.3 installation to your externalized datastores.

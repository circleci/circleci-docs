...
If you are installing locally rather than in AWS or GCP, follow the MinIO instructions in the xref:../air-gapped-installation/phase-2-configure-object-storage/phase-2-configure-object-storage#[Air-gapped installation docs].

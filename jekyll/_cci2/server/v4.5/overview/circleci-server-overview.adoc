...
image::server-4-architecture-diagram-2024.png[Server v4.5 services architecture]
...
* xref:release-notes#[CircleCI server v4.5 release notes]
* xref:../installation/phase-1-prerequisites#[Server v4.5 installation prerequisites]
endif::pdf[]

...
|`mongodb.auth.authenticationDatabase`
|string
|`"admin"`
|
...
|string
|`"root"`
|When MongoDB is externalized, use this to state the name of user needed to connected to the external database

|`mongodb.auth.password`
|string
|`""`
|When MongoDB is externalized, use this to state the password of user needed to connected to the external database

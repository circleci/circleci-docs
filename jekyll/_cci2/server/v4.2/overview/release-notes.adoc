...
=== Changelog
- Security Updates
- Removes the unused distributor_dispatcher.disable_concurrency value
For full details of this release see the link:https://circleci.com/server/changelog/#release-4-2-4[changelog].

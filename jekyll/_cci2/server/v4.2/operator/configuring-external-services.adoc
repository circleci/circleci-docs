...
This page describes how to configure external services for use with either a new CircleCI server v4.2 installation or migrating internal PostgreSQL and MongoDB data from existing CircleCI server v4.2 installation to your externalized datastores.

...
Find information about migration in the xref:server/installation/migrate-from-server-3-to-server-4.adoc[Migrate From Server v3 to v4 Guide].

== Upgrade
For upgrade steps see the xref:server/installation/upgrade-server-4.adoc[Upgrade Server v4 Guide]. 

...
When using a GitHub Enterprise instance with self-signed or custom authority certificates, CircleCI Server can be configured to trust these certificates with two methods as described below.

...
Once the steps on this page are complete, go to the link:/docs/server/v4.1/air-gapped-installation/phase-5-configure-circleci-runner/[Phase 5 - Configure CircleCI runner] guide.

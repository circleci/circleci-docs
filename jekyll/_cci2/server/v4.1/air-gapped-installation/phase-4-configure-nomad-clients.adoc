...
Note: It is recommended to use CircleCI's Nomad installation script to install Nomad and all required prerequisite configurations. INSERTLINKHERE
...
Once the steps on this page are complete, go to the link:/docs/server/v4.1/air-gapped-installation/phase-5-test-your-installation/[Phase 5 - Test your installation] guide.

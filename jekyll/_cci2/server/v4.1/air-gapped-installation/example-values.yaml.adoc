[#example-values-yaml]
=== Example Values.yaml file - Air-Gapped Installation
The following is an example values.yaml file for the Helm installation of CircleCI server in an air-gapped environment.
...
For more information about specific values, see the standard installation documentation.

...
:page-liquid:
:page-description: Find the steps and prerequisites for installing CircleCI server v4.1.
:icons: font
:experimental:
...
Instead of providing AWS access key and secret key credentials in your `values.yaml` file, you may choose to create the Kubernetes Secret yourself.

...
Configuring a proxy happens during xref:/docs/server/v4.1/installation/phase-2-core-services#l-installing-behind-a-proxy[Phase 2 - Core services].
...
* Some additional configuration is required to import orbs when installed behind a proxy. See xref:/docs/server/v4.1/operator/managing-orbs/#using-orbs-behind-a-proxy[Orbs on Server] docs for more information.

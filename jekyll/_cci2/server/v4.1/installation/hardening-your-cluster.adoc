...
ifndef::pdf[]
## Next steps
* xref:/server/v4.1/installation/migrate-from-server-3-to-server-4#[Migrate from Server v3.x to v4.x]
* xref:/server/v4.1/operator/operator-overview#[Server 4.x Operators Overview]
endif::[]

...
* xref:/docs/server/v4.1/installation/phase-3-execution-environments/#nomad-autoscaler-gcp[Nomad Autoscaler]
* xref:/docs/server/v4.1/installation/phase-3-execution-environments/#gcp-3[VM]
* xref:/docs/server/v4.1/installation/phase-1-prerequisites/#configuring-google-cloud-storage[Object-Storage]

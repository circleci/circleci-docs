...
* Ensure you have set up xref:/docs/server/v4.1/operator/backup-and-restore#[Backup and Restore].
* Ensure there is a recent backup. For more information, see the xref:/docs/server/v4.1/opertor/backup-and-restore#creating-backups[Backup and Restore] guide.

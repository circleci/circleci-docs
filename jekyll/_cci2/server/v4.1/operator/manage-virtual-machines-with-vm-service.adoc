...
CAUTION: We recommend that you leave these options at their defaults until you have successfully configured and verified the core and build services of your server installation. Steps to set up VM service are provided in the installation guide for xref:/docs/server/v4.1/installation/phase-3-execution-environments/#aws-vm-service[AWS] and xref:/docs/server/v4.1/installation/phase-3-execution-environments/#gcp-authentication[GCP].
...
[#aws]
=== AWS
There is a section in your `values.yaml` file that configures VM Service to work with AWS EC2. During installation you will have set up a security group and authentication. See the xref:/docs/server/v4.1/installation/phase-3-execution-environments/#aws-vm-service[Installation Phase 3 - Execution Environments] page for more information.
...
[#gcp]
=== GCP
There is a section in your `values.yaml` file that configures VM Service to work with GCP. During installation you will have set up a security group and authentication. See the xref:/docs/server/v4.1/installation/phase-3-execution-environments/#aws-vm-service[Installation Phase 3 - Execution Environments] page for more information.
...
NOTE: For a full list of options, see the xref:/docs/server/v4.1/installation/installation-reference/#all-values-yaml-options[Installation Reference] page.

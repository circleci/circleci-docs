...
For information on orbs and related use cases, see the xref:/docs/orb-intro#[orbs docs].
...
Orbs are accessed via the xref:/docs/local-cli#[CircleCI CLI]. Orbs require your CircleCI user to be an admin. They also require a xref:/docs/managing-api-tokens#[personal API token].

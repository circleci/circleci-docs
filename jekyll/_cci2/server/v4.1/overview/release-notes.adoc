...
Find information about migration in the xref:../installation/migrate-from-server-3-to-server-4#[Migrate From Server v3 to v4 Guide].

[#upgrade]
== Upgrade
For upgrade steps see the xref:../installation/upgrade-server-4#[Upgrade Server v4 Guide].

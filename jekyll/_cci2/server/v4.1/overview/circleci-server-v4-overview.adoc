...
* xref:/docs/server/v4.1/overview/release-notes#[CircleCI Server v4.x Release Notes]
* xref:/docs/server/v4.1/installation/phase-1-prerequisites#[Server 4.x Installation Prerequisites]
* xref:/docs/server/v4.1/installation/migrate-from-server-3-to-server-4#[Migrate from Server v3 to Server v4]
endif::pdf[]

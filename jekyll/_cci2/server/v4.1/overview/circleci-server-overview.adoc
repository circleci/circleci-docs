...
NOTE: For installation instructions, you have the option of either the xref:/server/v4.1/installation/phase-1-prerequisites#[regular] or link:/server/v4.1/air-gapped-installation/phase-1-prerequisites#[air-gapped] installation guide.

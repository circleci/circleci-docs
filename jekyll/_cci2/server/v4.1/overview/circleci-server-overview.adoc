...
- Server Admin
---
= CircleCI server v{serverversion41} overview
...
NOTE: For installation instructions, you have the option of either the link:/docs/server/v4.1/installation/phase-1-prerequisites/[regular] or link:/docs/server/v4.1/air-gapped-installation/phase-1-prerequisites/[air-gapped] installation guide.
...
* xref:server/v4.1/overview/release-notes#[CircleCI Server v4.x Release Notes]
* xref:server/v4.1/installation/phase-1-prerequisites#[Server 4.x Installation Prerequisites]
* xref:server/v4.1/installation/migrate-from-server-3-to-server-4#[Migrate from Server v3 to Server v4]
endif::pdf[]

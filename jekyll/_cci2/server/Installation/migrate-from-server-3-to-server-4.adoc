...
[#step-8-validate-your-migration-to-server-4]
=== Step 8 - Validate your migration to server v4.x
...
=== Step 9 - Execute cleanup step
Execute the following cleanup step to remove the `kots` annotation and pod:

CAUTION: Do not execute this step if you face any issues in above steps

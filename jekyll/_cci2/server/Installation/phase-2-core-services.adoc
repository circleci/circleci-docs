...
If you'd like to instead provision your own secret independently for GitHub, you can do so with the following command.
If you choose this method, do not provide `clientId`, `clientSecret` to the helm deployment.
...
Note: `defaultToken` must be included in addition to `clientId` and `clientSecret` when `enterprise` is set to true.

If you'd like to instead provision your own secret independently for GitHub enterprise, you can do so with the following command.
If you choose this method, do not provide `clientId`, `clientSecret`, or the `defaultToken` to the helm deployment.

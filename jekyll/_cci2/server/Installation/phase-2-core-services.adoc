...
[#github]
=== GitHub
These instructions are for the non-enterprise version of GitHub.
...
* *Option 2 - CircleCI creates the secret*
+
You created your Github OAuth application in the prerequisite phase. Add the client ID and secret to 

...
image::server-4-architecture-diagram-2024.png[server v4.8 services architecture]
...
* xref:release-notes#[CircleCI server v4.8 release notes].
* server v4.8 installation prerequisites for xref:../installation/phase-1-aws-prerequisites#[AWS] and xref:../installation/phase-1-gcp-prerequisites#[GCP].
endif::pdf[]

...
Before you begin with the CircleCI server v4.7 execution environment installation phase, ensure you have run through the prerequisites (xref:phase-1-aws-prerequisites#[Phase 1 AWS – Prerequisites], xref:phase-1-gcp-prerequisites#[Phase 1 GCP – Prerequisites]) and xref:phase-2-core-services#[Phase 2 - Core Services Installation].

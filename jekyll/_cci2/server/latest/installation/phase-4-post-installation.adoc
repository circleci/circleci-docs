...
:page-description: CircleCI server post installation steps for CircleCI server v4.6.
:icons: font
:toc: macro
:toc-title:
...
Before you begin with the CircleCI server v4.6 post installation phase, ensure you have run through xref:phase-1-prerequisites#[Phase 1 – Prerequisites], xref:phase-2-core-services#[Phase 2 - Core Services Installation] and xref:phase-3-execution-environments#[Phase 3 - Execution Environments Installation].

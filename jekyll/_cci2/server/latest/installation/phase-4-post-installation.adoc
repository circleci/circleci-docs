...
:page-description: CircleCI server v4.7 post installation steps
:icons: font
:toc: macro
:toc-title:
...
Before you begin with the CircleCI server v4.7 post installation phase, ensure you have run through the prerequisites (xref:phase-1-aws-prerequisites#[Phase 1 AWS – Prerequisites], xref:phase-1-gcp-prerequisites#[Phase 1 GCP – Prerequisites]), xref:phase-2-core-services#[Phase 2 - Core Services Installation] and xref:phase-3-execution-environments#[Phase 3 - Execution Environments Installation].

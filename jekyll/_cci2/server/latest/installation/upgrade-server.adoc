...
. Migrate any existing machine runner instances from the launch agent to the machine runner 3.0 agent, see the xref:../../../migrate-from-launch-agent-to-machine-runner-3-on-linux#[migration guide]. The launch agent is not supported.
...
:page-liquid:
:page-description: Learn how to upgrade MongoDB up to v4.6.15 in an installation of CircleCI server v4.6.
:icons: font
:toc: macro
:toc-title:
...
MongoDB `3.6.22` is shipped with CircleCI server v4.6.

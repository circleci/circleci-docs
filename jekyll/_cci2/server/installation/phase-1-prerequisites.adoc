...
To reserve a new static IP address in GCP, run the following gcloud command in your desired environment. More information is available link:https://cloud.google.com/compute/docs/ip-addresses/reserve-static-external-ip-address[here].

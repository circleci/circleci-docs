...
Before you begin with the CircleCI server v4.x core services installation phase, ensure all <<server/installation/phase-1-prerequisites#,prerequisites>> are met.

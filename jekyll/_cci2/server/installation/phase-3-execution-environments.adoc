...
Before running realitycheck, Check if Nomad Server can communicate with Nomad Clients by executing below command - 
...
You should be able to see ouput like below - 
```

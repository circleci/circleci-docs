...
Add the VM Service configuration to values.yaml. Details of the available configuration options can be found in the link:https://circleci.com/docs/2.0/server/manage-virtual-machines-with-vm-service[Managing Virtual Machines with VM Service] guide.

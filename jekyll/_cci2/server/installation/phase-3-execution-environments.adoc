...
Nomad requires a key to encrypt communications.  This must be exactly 32 bytes long. CircleCI will not be able to recover the values if lost. Depending on how you prefer to manage secrets, there are 2 options.

...
Before you begin with the CircleCI server v4.x post installation phase, ensure you have run through <<server/installation/phase-1-prerequisites#,Phase 1 – Prerequisites>>, <<server/installation/phase-2-core-services#,Phase 2 - Core Services Installation>> and <<server/installation/phase-3-execution-environments#,Phase 3 - Execution Environments Installation>>.
...
* link:/docs/server/installation/migrating-from-server-3-to-server-4[Server 4.x Migration]

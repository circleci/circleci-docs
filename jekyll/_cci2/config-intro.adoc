...
If you already have a `config.yml` file from the example above, add another run step (lines 13-17) at the end and a `checkout` command at line 7. Make sure you observe the indentation.

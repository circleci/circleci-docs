...
If you are a VS Code user, you might find the official [CircleCI extension](https://marketplace.visualstudio.com/items?itemName=circleci.circleci) useful when writing, editing, navigating and troubleshooting your YAML Config files.

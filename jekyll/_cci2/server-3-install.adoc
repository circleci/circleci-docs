...
* Postgres Persistent Volume Claim Size: The initial storage capacity made available to Postgres. The default size is 8Gi. This value can only be set once, after which you will need to refer to our documentation on resizing peristent volume claims to extend your storage.
...
* MongoDB Persisten Volume Claim Size: The initial storage capacity made available to MongoDB. The default size is 8Gi. This value can only be set once, after which you will need to refer to our documentation on resizing peristent volume claims to extend your storage.

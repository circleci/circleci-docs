...
are always running and could potentially increase costs.
...
As mentioned in the xref:server-3-overview.adoc[Overview], Nomad is a workload orchestration tool that CircleCI uses to
...
`app.circleci.your.domain.com19`, respectively. You will recall that in <<Step 2 - Configure Server (Part 1)>> we detailed how

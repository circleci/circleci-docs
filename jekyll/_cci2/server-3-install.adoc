...
need to configure this domain and point it to the traefik Load Balancer once it is configured in a later step.
...
Next, create DNS entries for your traefik load balancer, i.e. `circleci.your.domain.com` and

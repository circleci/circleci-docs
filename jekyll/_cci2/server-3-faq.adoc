...
:page-liquid:
:page-description: Find answers about Server 3.0's data retention policy, what control is granted over Nomad certificates, and application Status options in KOTS.
:icons: font
:toc: macro
:toc-title:

...
--
. Go to the menu:Project Settings[Triggers] of your project.
. Edit an existing GitHub App trigger or add a new GitHub App trigger.
. In the "Run on" dropdown list, select the "PR opened or pushed to, default branch pushes, tag pushes" option.

image::triggers/run-on-open-focus.png[Trigger options for a project trigger]
--

[.tab.create-project.GitHub_OAuth]
--
...
To change this setting, go to the menu:Project Settings[Advanced] of your project and set the *Only build pull requests* option to _On_.
...
image::project-settings-advanced.png[Project Settings > Advanced]


NOTE: CircleCI will build all commits from your project's _default branch and tags_ regardless of any setting.
--
...
. In the "Filters" section, select the "Only Build Merge Requests" option.

image::gl-ga/gitlab-ga-project-settings-edit-trigger.png[Set the "Only Build Merge Requests" option]
--

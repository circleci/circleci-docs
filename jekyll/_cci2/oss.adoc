...
. In the navigation menu of the *Project Settings* page, click *Triggers*.
...
include::../_includes/partials/app-navigation/steps-to-project-settings.adoc[Insert steps from selecting an organization up to the Project Settings page]
. In the navigation menu of the *Project Settings* page, click *Advanced*
...
image::triggers/gitlab-cloud-trigger-filter-only-mr.png[Set the Only Build Merge Requests option]
--
...
. In the navigation menu of the *Project Settings* page, click *Triggers*.
. Edit an existing GitLab Self-Managed trigger or add a new GitLab Self-Managed trigger.
. In the *Filters* section, select the *Only Build Merge Requests* option.

image::triggers/gitlab-self-managed-trigger-filter-only-mr.png[Set the Only Build Merge Requests option]
--

[.tab.create-project.Bitbucket_Cloud]
--
By default, CircleCI builds every commit from every branch. This behavior may be too aggressive for open source projects, which often have significantly more commits than private projects.

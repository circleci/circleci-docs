...
CircleCI 2.0 uses Nomad as the primary job scheduler. Refer to the <<nomad#,Introduction to Nomad Cluster Operation>> to learn more about the job scheduler and how to perform basic client and cluster operations.

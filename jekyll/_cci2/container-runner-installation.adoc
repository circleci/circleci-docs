...
[#download-launch-agent script and install binary]
== Download launch-agent script and install binary

NOTE: *If you are installing container runners on server, continue with the steps in the following section.* Otherwise, skip ahead to the xref:#container-runner-installation[next section].

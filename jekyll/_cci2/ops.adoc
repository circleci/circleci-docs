...
**Answer:**
Refer to the Configuration Chapter for details about monitoring and metrics.
...
**Answer:**
By default, the first user to access the CCIE instance after it is started becomes the admin.
...
=== Leftover VMs in Your AWS Account

...
<section style="
    ...
    margin: 20px 0;
">
    Installing self-hosted runners is now available directly in the <a href="https://app.circleci.com/" target="_blank">CircleCI web app</a> ! You will need to agree to the <a href="#self-hosted-runner-terms-agreement">Runner Terms</a> (see below) before this option is available to you in the UI.
</section>
++++
...
* sha256sum (installed by default on most macOS and Linux machines)

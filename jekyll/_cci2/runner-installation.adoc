...
NOTE: CircleCI runner is currently available on the https://circleci.com/pricing[Scale Plan]. Please reach out to your sales representative for information on how to sign up for the Scale Plan.
...
* xref:local-cli.md[CircleCI CLI]

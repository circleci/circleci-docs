...
- Note: If you are using a self-signed cert, or using a custom CA root, please see [certificate authorities doc]({{site.baseurl}}/2.0/certificate-authorities) for instructions adding the information to CircleCI's truststore.

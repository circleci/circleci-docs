...
* In order to provision required AWS entities with Terraform you need an IAM User with following permissions (for guidance on creating IAM users in your AWS account, head https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_create.html[here]):

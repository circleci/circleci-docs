...
contentTags:
  ...
  - Cloud
---
= Manually install machine runner 3.0 - Open preview
...
CAUTION: The recommended method for installing and using the CircleCI machine runner 3.0 is with xref:install-machine-runner-3-on-macos.adoc[the homebrew package] on macOS and xref:install-machine-runner-3-on-linux.adoc[the linux packages] on linux.

WARNING: A manually installed CircleCI machine runner 3.0 will not automatically update.

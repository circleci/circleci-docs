...
To switch to another Ruby version, see [our chruby documentation](#images-using-macos-1015-xcode-112-and-later). To revert back to the system Ruby, add the following to the beginning of your job:

...
Select a macOS project repository you would like to build on the Add Projects page of the CircleCI application. You will need to ensure you have a [plan that allows macOS builds]({{site.baseurl}}/pricing/), or if your project is open source, you can [apply for a special plan]({{site.baseurl}}/open-source/) with free monthly build credits.

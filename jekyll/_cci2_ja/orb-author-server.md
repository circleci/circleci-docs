...
この Orb オーサリングガイドは、[Orb の概要]({{site.baseurl}}/ja/2.0/orb-intro) と [Orb オーサリングの概要]({{site.baseurl}}/ja/2.0/orb-author-intro)のドキュメントを読み、名前空間を宣言していることを前提にしています。 これらが完了していれば、Orb の作成を開始できます。

...
NOTE: コンテキストを作成するほうがより柔軟性の高い方法です。 CircleCI supports multiple contexts, which is an effective way to modularize secrets, ensuring jobs can only access what they _need_.

...
## ビルドのキューイングのデバッグ
ビルドのキューイングのデバッグに関する問題を解決するには、CircleCI Server 2.x のhttps://circleci.com/docs/troubleshooting/?section=server-administration#debug-queuing-builds[[トラブルシューティング]]ガイドを参照してください。

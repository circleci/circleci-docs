...
- Gradle を使ってビルドした link:https://gradle.org/[Android プロジェクト]. 
...
- CircleCI を使ったデプロイの概要 および Google Cloud Platform、AWS、Heroku などの特定のデプロイターゲットの例については、 xref:deployment-overview.adoc[デプロイの概要] を参照してください。 
...
VM service enables users of CircleCI server, installed on AWS, to run jobs using the https://circleci.com/docs/ja/2.0/building-docker-images[Remote Docker Environment] and the https://circleci.com/docs/ja/2.0/executor-types/#using-machine[`machine` executor].

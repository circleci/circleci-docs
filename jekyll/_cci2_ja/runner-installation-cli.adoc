...
<section style="
    ...
    margin: 20px 0;
">
   セルフホストランナーは、<a href="https://app.circleci.com/" target="_blank">CircleCI Web アプリ</a>から直接インストールできるようになりました！ このオプションを UI で使用できるようにするには、 <a href="#self-hosted-runer-terms -agreement">ランナー規約</a> に同意する必要があります。
</section>
++++

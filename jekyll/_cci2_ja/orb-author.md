...
1. **Open a terminal and initialize your new orb project using the `orb init` CLI command.** To initialize a **[public](https://circleci.com/docs/2.0/orb-intro/#public-orbs)** orb:
```bash

...
CircleCI の [料金ページ](https://circleci.com/pricing/) で、無料および有料のオプションをご確認ください。
...
{: #in-the-docs }
{:.no_toc}
- [コンセプト]({{site.baseurl}}/2.0/concepts/): CI/CD パイプライン管理の基本的なコンセプトについて
- [チュートリアル]({{site.baseurl}}/2.0/tutorials/): プラットフォーム固有のチュートリアルについて

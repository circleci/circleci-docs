...
title: "概要"
short-title: "概要"
description: "CircleCI 2.0 マニュアルへようこそ"
...
- **クラウド型**：クラウドサーバー上にホスティングした CircleCI を試せるものです。[無料トライアルはこちら]({{site.baseurl}}/ja/2.0/first-steps/)。
- **サーバー型**：自身のサーバー上で CircleCI の動作を試せるものです。[インストール方法はこちら]({{site.baseurl}}/ja/2.0/single-box/)。
...
Linux, Android, そしてmacOS上で動くアプリケーションがサポートされています。サンプルや手順に関する詳細は[サポートされる言語]({{site.baseurl}}/ja/2.0/demo-apps)をご覧ください。

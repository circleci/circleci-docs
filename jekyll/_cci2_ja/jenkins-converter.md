...
使用例によっては、アプリケーションで OS リソースとジョブ環境へのフルアクセスが必要な場合は、[macOS Executor]({{site.baseurl}}/2.0/using-macos) または [Machine Executor]({{site.baseurl}}/2.0/configuration-reference/#machine) が必要な場合があります。

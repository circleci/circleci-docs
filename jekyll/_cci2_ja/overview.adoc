...
Currently not supported for Server: https://circleci.com/docs/ja/2.0/orb-intro/#section=configuration[orbs], https://circleci.com/docs/ja/2.0/reusing-config/#authoring-reusable-commands[reusable commands], https://circleci.com/docs/ja/2.0/build-processing/[pipelines].

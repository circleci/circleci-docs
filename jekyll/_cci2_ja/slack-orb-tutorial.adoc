...
CircleCI では、コンテキストを使用するとプロジェクト間で環境変数を保護し、共有することができます。 Once you have created a context with your Slack credentials, you and your colleagues will be able to reuse them.

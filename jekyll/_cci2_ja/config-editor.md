...
With the CircleCI configuration editor, you can modify your configuration files without the use of the [CircleCI CLI]({{site.baseurl}}/local-cli/) or a text editor. また、CI/CD プロセスを統一された方法で迅速に変更できます。
...
- [CircleCI 設定のリファレンス]({{site.baseurl}}/configuration-reference)
- [CircleCI のローカル CLI の使用]({{site.baseurl}}/local-cli)

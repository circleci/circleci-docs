...
Orbs are accessed via the https://circleci.com/docs/local-cli/[CircleCI CLI]. Orb を使用するには、管理者である必要があります。 They also require a https://circleci.com/docs/managing-api-tokens/[personal API token].

...
Orb と 関連するユースケースについては、https://circleci.com/docs/2.0/orb-intro/#quick-start[Orb に関するドキュメント]を参照してください。


Orb の作成に関する情報は、https://circleci.com/docs/2.0/orb-author-intro/[Orb オーサリングの概要]を参照してください。

toc::[]

## Orb の管理
Orb には、https://circleci.com/docs/2.0/local-cli/[CircleCI CLI] からアクセスします。 Orb を使用するには、管理者である必要があります。 また、https://circleci.com/docs/2.0/managing-api-tokens/[パーソナル API トークン]が必要です。

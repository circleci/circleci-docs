...
* [Orb 開発キット]({{site.baseurl}}/orb-development-kit)を使用する (推奨)
...
Orb 開発キットを使用している場合、オーブのパッケージ化は、含まれている CI/CD パイプラインにより [orb-tools/pack](https://circleci.com/developer/orbs/orb/circleci/orb-tools#jobs-pack) ジョブで自動的に処理されます。
{: class="alert alert-warning"}

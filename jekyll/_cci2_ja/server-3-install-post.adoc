...
ビルドの通知はメールで送信されます。 This section has details on how to set up build notifications by email. 

KOTS の管理コンソールにアクセスします。 Get to the KOTS admin console by running the following, substituting your namespace: 

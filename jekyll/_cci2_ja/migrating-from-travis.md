...
| matrix:           | [matrix:]({{site.baseurl}}/ja/configuration-reference/#matrix)                                                                          | CircleCI ではワークフローを使用して複数のジョブをオーケストレーションできます。                                                                                                                                                    |
...
また、CircleCI には [定義済み環境変数]({{site.baseurl}}/ja/variables#built-in-environment-variables)が複数用意されています。

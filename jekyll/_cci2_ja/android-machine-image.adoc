...
CircleCI Server 3.4 以降では、GCP へのインストールでは Android マシンイメージがサポートされています。 To use the Android image in your projects set the `image` key to `android-default` in your jobs.

...
=== Prometheus
https://prometheus.io/[Prometheus] は、Kubernetes 用の優れた監視およびアラート システムです。 Server 3.x ships with a basic implementation of monitoring common performance metrics.

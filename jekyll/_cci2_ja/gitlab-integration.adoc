...
NOTE: Existing CircleCI users can also opt to sign up using email and password. When you connect the same VCS account to your email/password account, your CircleCI accounts will be merged. 詳細は、このページのユーザー設定のセクションの <<#user-account-integrations,アカウント連携>> をご覧下さい。
--

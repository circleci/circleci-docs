...
組織やプロジェクトを追加する必要がある場合は、 xref:plan-overview.adoc[有料プラン] へのアップグレードをご検討いただくか、または link:https://support.circleci.com/hc/en-us/requests/new[当社のサポートチーム] にお問い合わせください。
====

...
CircleCI Server v4.x のポストインストールステップを開始する前に、ink:/docs/ja/server/installation/phase-1-prerequisites[ステップ 1 - 前提条件] 、link:/docs/ja/server/installation/phase-2-core-services[ステップ 2 - コアサービスのインストール] 、link:/docs/ja/server/installation/phase-3-execution-environments[ステップ 3 - ビルドサービスのインストール] が実行済みであることを確認してください。

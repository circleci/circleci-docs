...
|整数
|`25`
|ポート 25 のアウトバウンド接続は、ほとんどのクラウドプロバイダーでブロックされます。 このデフォルトのポートを選択する場合は、通知の送信に失敗する可能性があることに留意してください。
...
|整数
|`1`
|soketi をデプロイするためにデプロイするレプリカの数です。
...
|整数
|`1`
| test-results-service をデプロイするためにデプロイするレプリカの数です。
...
|ブール値
|`true`
|このチャートの Internal Vault インスタンスを無効にします。
...
|整数
|`1`
| vm-gc をデプロイするためにデプロイするレプリカの数です。
...
|整数
|`1`
| vm-scaler をデプロイするためにデプロイするレプリカの数です。
...
|整数
|`1`
| vm-service をデプロイするためにデプロイするレプリカの数です。

|web_ui.replicas
|整数
|`1`
|web-ui をデプロイするためにデプロイするレプリカの数です。

|web_ui_404.replicas
|整数
|`1`
|web-ui-404 をデプロイするためにデプロイするレプリカの数です。

|web_ui_insights.replicas
|整数
|`1`
|web-ui-insights をデプロイするためにデプロイするレプリカの数です。

|web_ui_onboarding.replicas
|整数
|`1`
|web-ui-onboarding をデプロイするためにデプロイするレプリカの数です。

|web_ui_org_settings.replicas
|整数
|`1`
|web-ui-org-settings をデプロイするためにデプロイするレプリカの数です。

|web_ui_project_settings.replicas
|整数
|`1`
|web-ui-project-settings をデプロイするためにデプロイするレプリカの数です。

|web_ui_server_admin.replicas
|整数
|`1`
|web-ui-server-admin をデプロイするためにデプロイするレプリカの数です。

|web_ui_user_settings.replicas
|整数
|`1`
|web-ui-user-settings をデプロイするためにデプロイするレプリカの数です。
...
|整数
|`1`
|webhook-service をデプロイするためにデプロイするレプリカの数です。

|workflows_conductor_event_consumer.replicas
|整数
|`1`
|workflows-conductor-event-consumer をデプロイするためにデプロイするレプリカの数

|workflows_conductor_grpc.replicas
|整数
|`1`
|workflows-conductor-grpc をデプロイするためにデプロイするレプリカの数です。
|===
...
* プロキシ経由でインストールすると、Orb をインポートするための設定が追加で必要です。 See link:/docs/server/operator/managing-orbs/#using-orbs-behind-a-proxy[Orbs on Server] docs for more information.

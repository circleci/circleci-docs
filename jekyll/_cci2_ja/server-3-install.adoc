...
You created your GitHub OAuth application in the prerequisite phase. 以下の作業を行ってください。
...
Required when using a proxy. `ssh-keyscan github.example.com` の出力をテキストフィールドに記載します。

...
* *`policy.json` (必須)* - https://circleci.com/docs/ja/2.0/CircleCI-Server-3.4.1-AWS-Installation-Guide.pdf[サーバーの AWS インストールガイド] の P. 11 を参照して下さい。
...
* *`policy.json` (必須)* - https://circleci.com/docs/2.0/CircleCI-Server-3.4.1-AWS-Installation-Guide.pdf[サーバーのAWS インストールガイド] の P. 8 を参照して下さい。

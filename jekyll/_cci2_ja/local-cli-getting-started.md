...
このステップでは、ターミナルを離れる必要があります。 Head over to the **Projects** page on the [CircleCI web app](https://app.circleci.com/). It is time to set up your project to run CI whenever you push code.

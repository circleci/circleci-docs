...
{: #supported-xcode-versions }
 ...
 | 設定       | Xcode のバージョン                 | macOS のバージョン | VM Software Manifest                                                                         | Bare Metal Software Manifest                                                                                     | リリースノート                                                                                       |
 | -------- | ---------------------------- | ------------ | -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
 | `13.3.0` | Xcode 13.3 Beta 2 (13E5095k) | 12.2         | [インストール済みソフトウェア](https://circle-macos-docs.s3.amazonaws.com/image-manifest/v6900/index.html) | [インストール済みソフトウェア](https://circle-macos-docs.s3.amazonaws.com/image-manifest/cci-macos-production-2390/index.html) | [リリースノート](https://discuss.circleci.com/t/macos-monterey-xcode-13-3-beta-2-released/42919)     |
 ...
 | `10.3.0` | Xcode 10.3 (10G8)            | 10.14.4      | [インストール済みソフトウェア](https://circle-macos-docs.s3.amazonaws.com/image-manifest/v1925/index.html) | n/a<sup>(1)</sup>                                                                                                | [リリースノート](https://discuss.circleci.com/t/xcode-10-3-image-released/31561)                     |

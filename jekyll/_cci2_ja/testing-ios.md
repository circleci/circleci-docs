...
{: #supported-xcode-versions }
 ...
 | -------- | ---------------------------- | ------------ | ----------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
 | `13.3.0` | Xcode 13.3 Beta 2 (13E5095k) | 12.2         | ○                 | [インストール済みソフトウェア](https://circle-macos-docs.s3.amazonaws.com/image-manifest/v6900/index.html) | [リリースノート](https://discuss.circleci.com/t/macos-monterey-xcode-13-3-beta-2-released/42919)     |

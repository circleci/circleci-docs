...
これらの環境変数の設定方法の詳細については、[環境変数に関するドキュメント](https://circleci.com/ja/docs/ja/2.0/env-vars/)を参照してください。
...
これらの環境変数の設定方法の詳細については、[環境変数の使用](https://circleci.com/ja/docs/ja/2.0/env-vars/)を参照してください。

...
You will be able to start exploring features such as link:/docs/pipelines[pipelines] and link:/docs/workflows[workflows]. **Dashboard** 、 **Projects**、 **Organization Settings** 、および **Plan** のページは、コードに接続するまで使用できません。

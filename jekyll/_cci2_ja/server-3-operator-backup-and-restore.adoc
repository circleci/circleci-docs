...
To restore from a backup stored
...
server from a kots backup does not require you to reinstall server yourself before-hand. When using GKE or other platforms, a cluster with just velero installed may work.  

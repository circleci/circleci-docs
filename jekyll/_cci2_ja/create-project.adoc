...
CircleCI プロジェクトとお客様の VCS 内の既存のリポジトリをリンクさせる必要があります。 Make sure you have a repo and that you have authorized CircleCI to access it (in GitHub, you have the option to block CircleCI from accessing your private repositories).

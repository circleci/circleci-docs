...
description: CircleCI プロジェクトの設定ファイルの設定ポリシーの管理
version:
- クラウド 
---
= 設定ポリシーの管理の概要
...
NOTE: 設定ポリシーの管理が **Scale** プランでご利用いただけるようになました。現在 **オープンプレビュー** であり、 All aspects of the feature are subject to change.

...
* v2.18 では Redis の設定を一部変更しました。 If you have externalized Redis then you will need to update your configuration. 2.18 以前のバージョンから 2.19 にアップグレードする場合は、担当のカスタマーサクセスマネージャーまでお問い合わせください。

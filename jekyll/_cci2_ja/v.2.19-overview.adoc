...
* We made some changes to our Redis configuration in v2.18. Redis を外部処理化している場合は、構成を更新する必要があります。 Please contact your Customer Success Manager if you are upgrading from pre v2.18 to v2.19.

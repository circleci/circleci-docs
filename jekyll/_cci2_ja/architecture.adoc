...
* With a Premium support contract, some services can be externalized (marked with * here) and managed to suit your requirements. 外部化することで、データの安全性が高まり、システムに冗長性を持たせることができます。

...
**Notifications**: 新しい機能や変更に関するヒントです。 新しい通知は、ナビゲーション項目の横にバッジで示されます。
...
サイドナビゲーションの一番下に (スクロールする必要があるかもしれません)、ご自身の **user icon** が表示されます。 このアイコンをクリックすると、ご自身の **User Settings** に移動します。
...
組織に関連づけられたプロジェクトがプロジェクトのページに表示されます。 CircleCI に既に設定されているプロジェクトをフォローするか、フォローを解除するか、または CircleCI でプロジェクトをセットアップするかを選択できます。 Following or setting up a project will add it to your dashboard. Unfollowing a project will remove it from your dashboard.

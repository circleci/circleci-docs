...
**Note:** `cimg/python:3.10.1` is a [convenience image]({{ site.baseurl }}/2.0/circleci-images/) provided by CircleCI. これらのイメージは正式な Docker イメージの拡張版で、CI/CD 環境にとって便利なツールが含まれます。

...
Google Cloud Platform にデプロイする前に、Google Cloud SDK を承認して、デフォルトの設定を行う必要があります。 Refer to the <<deploy-to-google-cloud-platform#,Authorizing the Google Cloud SDK>> document for full details.

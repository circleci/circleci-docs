...
This document describes best practices for using shell scripts in your [CircleCI configuration]({{ site.baseurl }}/ja/2.0/configuration-reference/) in the following sections:

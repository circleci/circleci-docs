...
下記の環境変数を設定する必要があります。 For more information on how to set environment variables, refer to the <<set-environment-variable#,Set an environment variable>> page. You can also use a <<contexts#,context>>:

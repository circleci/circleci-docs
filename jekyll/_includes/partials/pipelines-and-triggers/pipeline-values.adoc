...
| GitHub App
| String
| Only populated for pipelines triggered [by pull request events] (`pipeline.event.name = 'pull_request'`). It contains the name of the *base* (or target) branch of the PR - that is the branch that will receive the changes.
| icon:check[]
| icon:times[]
...
| GitHub App
| String
| Only populated for pipelines triggered [by pull request events] (`pipeline.event.name = "pull_request"`). It contains the name of the *base* branch of the PR - that is the branch containing the changes to be merged. 
| icon:check[]
| icon:times[]

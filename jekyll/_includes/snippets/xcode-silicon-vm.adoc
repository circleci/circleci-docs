...
| 14.1
| link:https://circle-macos-docs.s3.amazonaws.com/image-manifest/v14430/manifest.txt[Installed software]
| link:https://discuss.circleci.com/t/xcode-15-3-beta-3-released/50564[Release Notes]

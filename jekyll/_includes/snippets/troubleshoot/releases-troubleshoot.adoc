...
* Check that the Deployment/Rollout is annotated ith the required labels. More information is available in the link:/docs/configure-your-kubernetes-components#[Set up guides]. If the required labels were not presetn, then adding them should solve the problem.

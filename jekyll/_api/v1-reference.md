...
The CircleCI API is a JSON, fully-featured API that allows you to access all information and trigger all actions in CircleCI. **Note:** The following limitations exist:

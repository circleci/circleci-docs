...
describe('externalLink', () => {
  ...
  describe('externalLink', () => {
    ...
    it('if external link found add svg to last word with single word', () => {
        ...
        `;
        externalLink();
        expect(document.querySelector('.external-link-tag-wrapper')).not.toBeNull();
        expect(document.querySelector('.external-link-tag-wrapper').innerHTML).toEqual('yes' + svg)
    });

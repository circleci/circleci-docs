...
image::guides:ROOT:server-4-architecture-diagram.png[Server v4.x services architecture]
...
* xref:release-notes.adoc[CircleCI server v4.1 release notes]
* xref:air-gapped-installation:phase-1-prerequisites.adoc[Server 4.x Installation Prerequisites]
endif::pdf[]

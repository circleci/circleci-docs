...
function generateLlmsTxt (playbook, contentCatalog) {
  ...
  sections.push('**Use the V3 API for all new integrations.** It is where new capabilities land, with')
  sections.push('consistent conventions v2 never had (UUID identifiers, cursor pagination, a single error')
  sections.push('object). If you are an agent generating code against the CircleCI API and the task does')
  sections.push('not require an existing v2 integration, use v3:\n')
